...
// monadic lift
export function _mlift_unroll_foldl_10005_10819(f, xx, _y_x10478) /* forall<a,b,e> (f : (b, a) -> e b, xx : list<a>, b) -> e b */  {
...
export function _unroll_foldl_10005(xs, z, f_0) /* forall<a,b,e> (xs : list<a>, z : b, f : (b, a) -> e b) -> e b */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_10866 = f_0(z, xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10478_0 /* 1073 */ ) {
        return _mlift_unroll_foldl_10005_10819(f_0, xs.tail, _y_x10478_0);
      });
    }
    else {
      {
...
// monadic lift
export function _mlift_lift_foldr_10363_10820(_uniq_xx_10288, f, _uniq_z_10284_0_10373) /* forall<a,b,e> (list<a>, f : (a, b) -> e b, b) -> e b */  {
...
export function _lift_foldr_10363(f_0, _uniq_xs_10283, _uniq_z_10284) /* forall<a,b,e> (f : (a, b) -> e b, list<a>, b) -> e b */  { tailcall: while(1)
{
  if (_uniq_xs_10283 !== null) {
    ...
    var x_10869 = f_0(_uniq_xs_10283.head, _uniq_z_10284);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_uniq_z_10284_0_10373_0 /* 1117 */ ) {
        return _mlift_lift_foldr_10363_10820(_uniq_xs_10283.tail, f_0, _uniq_z_10284_0_10373_0);
      });
    }
    else {
      {
...
export function foldr1(xs, f) /* forall<a,e> (xs : list<a>, f : (a, a) -> <exn|e> a) -> <exn|e> a */  {
  ...
  var xs_0_10050 = $std_core_hnd._open_none1(function(xs_2 /* list<1195> */ ) {
      if (xs_2 === null) {
        return $std_core_types.Nil;
      }
      else {
        return _unroll_lift_reverse_append_4948_10003($std_core_types.Nil, xs_2);
      }
    }, xs);
  if (xs_0_10050 !== null) {
    if (xs_0_10050.tail === null) {
      return xs_0_10050.head;
    }
    else {
      return _unroll_foldl_10005(xs_0_10050.tail, xs_0_10050.head, f);
    }
  }
  else {
    return $std_core_hnd._open_at2($std_core_hnd._evv_index($std_core_exn._tag_exn), $std_core_exn.$throw, "unexpected Nil in std/core/foldl1");
...
// monadic lift
export function _mlift_unroll_drop_while_10006_10821(predicate, xs, xx, _y_x10496) /* forall<a,e> (predicate : (a) -> e bool, xs : list<a>, xx : list<a>, bool) -> e list<a> */  {
  if (_y_x10496) {
...
export function _unroll_drop_while_10006(xs_0, predicate_0) /* forall<a,e> (xs : list<a>, predicate : (a) -> e bool) -> e list<a> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    ...
    var x_0_10872 = predicate_0(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10496_0 /* bool */ ) {
        return _mlift_unroll_drop_while_10006_10821(predicate_0, xs_0, xs_0.tail, _y_x10496_0);
      });
    }
    else {
      if (x_0_10872) {
...
// monadic lift
export function _mlift_trmc_unroll_filter_10007_10822(_acc, pred, x, xx, _y_x10502) /* forall<a,e> (ctx<list<a>>, pred : (a) -> e bool, x : a, xx : list<a>, bool) -> e list<a> */  {
  if (_y_x10502) {
...
// monadic lift
export function _mlift_trmcm_unroll_filter_10007_10823(_accm, pred_0, x_0, xx_0, _y_x10507) /* forall<a,e> ((list<a>) -> list<a>, pred : (a) -> e bool, x : a, xx : list<a>, bool) -> e list<a> */  {
  if (_y_x10507) {
...
export function _trmc_unroll_filter_10007(xs, pred_1, _acc_0) /* forall<a,e> (xs : list<a>, pred : (a) -> e bool, ctx<list<a>>) -> e list<a> */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_2_10875 = pred_1(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10502_0 /* bool */ ) {
        return _mlift_trmc_unroll_filter_10007_10822(_acc_0, pred_1, xs.head, xs.tail, _y_x10502_0);
      });
    }
    else {
      if (x_2_10875) {
...
export function _trmcm_unroll_filter_10007(xs_0, pred_2, _accm_0) /* forall<a,e> (xs : list<a>, pred : (a) -> e bool, (list<a>) -> list<a>) -> e list<a> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    ...
    var x_4_10878 = pred_2(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10507_0 /* bool */ ) {
        return _mlift_trmcm_unroll_filter_10007_10823(_accm_0, pred_2, xs_0.head, xs_0.tail, _y_x10507_0);
      });
    }
    else {
      if (x_4_10878) {
...
// monadic lift
export function _mlift_trmc_unroll_filter_map_10008_10824(_acc, pred, xx, _y_x10517) /* forall<a,b,e> (ctx<list<b>>, pred : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e list<b> */  {
  if (_y_x10517 === null) {
    ...
    var _trmc_x10388 = $std_core_types.Cons(_y_x10517.value, _trmc_x10387);
...
// monadic lift
export function _mlift_trmcm_unroll_filter_map_10008_10825(_accm, pred_0, xx_0, _y_x10522) /* forall<a,b,e> ((list<b>) -> list<b>, pred : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e list<b> */  {
  if (_y_x10522 === null) {
    ...
    return _trmcm_unroll_filter_map_10008(xx_0, pred_0, function(_trmc_x10390 /* list<1393> */ ) {
        return _accm($std_core_types.Cons(_y_x10522.value, _trmc_x10390));
      });
  }
}
...
export function _trmc_unroll_filter_map_10008(xs, pred_1, _acc_0) /* forall<a,b,e> (xs : list<a>, pred : (a) -> e maybe<b>, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (xs === null) {
    ...
    var x_0_10881 = pred_1(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10517_0 /* maybe<1393> */ ) {
        return _mlift_trmc_unroll_filter_map_10008_10824(_acc_0, pred_1, xs.tail, _y_x10517_0);
      });
    }
    else {
      if (x_0_10881 === null) {
        ...
        var _trmc_x10388_0 = $std_core_types.Cons(x_0_10881.value, _trmc_x10387_0);
        {
          // tail call
...
export function _trmcm_unroll_filter_map_10008(xs_0, pred_2, _accm_0) /* forall<a,b,e> (xs : list<a>, pred : (a) -> e maybe<b>, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (xs_0 === null) {
    ...
    var x_2_10884 = pred_2(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10522_0 /* maybe<1393> */ ) {
        return _mlift_trmcm_unroll_filter_map_10008_10825(_accm_0, pred_2, xs_0.tail, _y_x10522_0);
      });
    }
    else {
      if (x_2_10884 === null) {
...
// monadic lift
export function _mlift_unroll_foreach_while_10009_10826(action, xx, _y_x10532) /* forall<a,b,e> (action : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e maybe<b> */  {
  if (_y_x10532 === null) {
...
export function _unroll_foreach_while_10009(xs, action_0) /* forall<a,b,e> (xs : list<a>, action : (a) -> e maybe<b>) -> e maybe<b> */  { tailcall: while(1)
{
  if (xs === null) {
    ...
    var x_0_10887 = action_0(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10532_0 /* maybe<1454> */ ) {
        return _mlift_unroll_foreach_while_10009_10826(action_0, xs.tail, _y_x10532_0);
      });
    }
    else {
      if (x_0_10887 === null) {
...
// monadic lift
export function _mlift_lift_find_10364_10827(_uniq_x_10297, _uniq_xx_10298, pred, _y_x10538) /* forall<a,e> (a, list<a>, pred : (a) -> e bool, bool) -> e maybe<a> */  {
  if (_y_x10538) {
...
export function _lift_find_10364(pred_0, _uniq_xs_10293) /* forall<a,e> (pred : (a) -> e bool, list<a>) -> e maybe<a> */  { tailcall: while(1)
{
  if (_uniq_xs_10293 === null) {
    ...
    var x_10890 = pred_0(_uniq_xs_10293.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10538_0 /* bool */ ) {
        return _mlift_lift_find_10364_10827(_uniq_xs_10293.head, _uniq_xs_10293.tail, pred_0, _y_x10538_0);
      });
    }
    else {
      if (x_10890) {
...
// monadic lift
export function _mlift_trmc_unroll_map_10010_10828(_acc, f, xx, _trmc_x10393) /* forall<a,b,e> (ctx<list<b>>, f : (a) -> e b, xx : list<a>, b) -> e list<b> */  {
...
// monadic lift
export function _mlift_trmcm_unroll_map_10010_10829(_accm, f_0, xx_0, _trmc_x10398) /* forall<a,b,e> ((list<b>) -> list<b>, f : (a) -> e b, xx : list<a>, b) -> e list<b> */  {
...
export function _trmc_unroll_map_10010(xs, f_1, _acc_0) /* forall<a,b,e> (xs : list<a>, f : (a) -> e b, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_10893 = f_1(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10393_0 /* 1969 */ ) {
        return _mlift_trmc_unroll_map_10010_10828(_acc_0, f_1, xs.tail, _trmc_x10393_0);
      });
    }
    else {
      ...
      var _trmc_x10395_0 = $std_core_types.Cons(x_0_10893, _trmc_x10394_0);
      {
        // tail call
...
export function _trmcm_unroll_map_10010(xs_0, f_2, _accm_0) /* forall<a,b,e> (xs : list<a>, f : (a) -> e b, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    ...
    var x_2_10896 = f_2(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10398_0 /* 1969 */ ) {
        return _mlift_trmcm_unroll_map_10010_10829(_accm_0, f_2, xs_0.tail, _trmc_x10398_0);
      });
    }
    else {
      {
        // tail call
        var _x25 = function(__at_accm_023 /* (list<1969>) -> list<1969> */ , _x_2_1089624 /* 1969 */ ) {
          return function(_trmc_x10397_0 /* list<1969> */ ) {
            return __at_accm_023($std_core_types.Cons(_x_2_1089624, _trmc_x10397_0));
          };
        }(_accm_0, x_2_10896);
        xs_0 = xs_0.tail;
        _accm_0 = _x25;
...
// monadic lift
export function function_fs__mlift_trmc_list_10830(_acc, f, hi, lo, _trmc_x10402) /* forall<a,e> (ctx<list<a>>, f : (int) -> e a, hi : int, lo : int, a) -> e list<a> */  {
...
// monadic lift
export function function_fs__mlift_trmcm_list_10831(_accm, f_0, hi_0, lo_0, _trmc_x10407) /* forall<a,e> ((list<a>) -> list<a>, f : (int) -> e a, hi : int, lo : int, a) -> e list<a> */  {
...
export function function_fs__trmc_list(lo_1, hi_1, f_1, _acc_0) /* forall<a,e> (lo : int, hi : int, f : (int) -> e a, ctx<list<a>>) -> e list<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(lo_1,hi_1)) {
    ...
    var x_10899 = f_1(lo_1);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10402_0 /* 1754 */ ) {
        return function_fs__mlift_trmc_list_10830(_acc_0, f_1, hi_1, lo_1, _trmc_x10402_0);
      });
    }
    else {
      ...
      var _trmc_x10404_0 = $std_core_types.Cons(x_10899, _trmc_x10403_0);
      {
        // tail call
...
export function function_fs__trmcm_list(lo_2, hi_2, f_2, _accm_0) /* forall<a,e> (lo : int, hi : int, f : (int) -> e a, (list<a>) -> list<a>) -> e list<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(lo_2,hi_2)) {
    ...
    var x_0_10902 = f_2(lo_2);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10407_0 /* 1754 */ ) {
        return function_fs__mlift_trmcm_list_10831(_accm_0, f_2, hi_2, lo_2, _trmc_x10407_0);
      });
    }
    else {
      {
        ...
        var _x33 = function(__at_accm_030 /* (list<1754>) -> list<1754> */ , _x_0_1090231 /* 1754 */ ) {
          return function(_trmc_x10406_0 /* list<1754> */ ) {
            return __at_accm_030($std_core_types.Cons(_x_0_1090231, _trmc_x10406_0));
          };
        }(_accm_0, x_0_10902);
        lo_2 = _x32;
        _accm_0 = _x33;
...
// monadic lift
export function stridefunction_fs__mlift_trmc_list_10832(_acc, f, hi, lo, stride, _trmc_x10410) /* forall<a,e> (ctx<list<a>>, f : (int) -> e a, hi : int, lo : int, stride : int, a) -> e list<a> */  {
...
// monadic lift
export function stridefunction_fs__mlift_trmcm_list_10833(_accm, f_0, hi_0, lo_0, stride_0, _trmc_x10415) /* forall<a,e> ((list<a>) -> list<a>, f : (int) -> e a, hi : int, lo : int, stride : int, a) -> e list<a> */  {
...
export function stridefunction_fs__trmc_list(lo_1, hi_1, stride_1, f_1, _acc_0) /* forall<a,e> (lo : int, hi : int, stride : int, f : (int) -> e a, ctx<list<a>>) -> e list<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(lo_1,hi_1)) {
    ...
    var x_10905 = f_1(lo_1);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10410_0 /* 1873 */ ) {
        return stridefunction_fs__mlift_trmc_list_10832(_acc_0, f_1, hi_1, lo_1, stride_1, _trmc_x10410_0);
      });
    }
    else {
      ...
      var _trmc_x10412_0 = $std_core_types.Cons(x_10905, _trmc_x10411_0);
      {
        // tail call
...
export function stridefunction_fs__trmcm_list(lo_2, hi_2, stride_2, f_2, _accm_0) /* forall<a,e> (lo : int, hi : int, stride : int, f : (int) -> e a, (list<a>) -> list<a>) -> e list<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(lo_2,hi_2)) {
    ...
    var x_0_10908 = f_2(lo_2);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10415_0 /* 1873 */ ) {
        return stridefunction_fs__mlift_trmcm_list_10833(_accm_0, f_2, hi_2, lo_2, stride_2, _trmc_x10415_0);
      });
    }
    else {
      {
        ...
        var _x42 = function(__at_accm_039 /* (list<1873>) -> list<1873> */ , _x_0_1090840 /* 1873 */ ) {
          return function(_trmc_x10414_0 /* list<1873> */ ) {
            return __at_accm_039($std_core_types.Cons(_x_0_1090840, _trmc_x10414_0));
          };
        }(_accm_0, x_0_10908);
        lo_2 = _x41;
        _accm_0 = _x42;
...
export function string_fs_map(s, f) /* forall<e> (s : string, f : (char) -> e char) -> e string */  {
  ...
  if (xs_10066 === null) {
    var x_10911 = $std_core_types.Nil;
  }
  else {
    var x_10911 = _unroll_map_10010(xs_10066, f);
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend($std_core_string.listchar_fs_string);
  }
  else {
    return $std_core_string.listchar_fs_string(x_10911);
  }
}
 
 
// monadic lift
export function _mlift_trmc_unroll_lift_map_indexed_4949_10011_10834(_acc, f, i_0_10069, yy, _trmc_x10416) /* forall<a,b,e> (ctx<list<b>>, f : (idx : int, value : a) -> e b, i@0@10069 : int, yy : list<a>, b) -> e list<b> */  {
...
// monadic lift
export function _mlift_trmcm_unroll_lift_map_indexed_4949_10011_10835(_accm, f_0, i_0_10069_0, yy_0, _trmc_x10421) /* forall<a,b,e> ((list<b>) -> list<b>, f : (idx : int, value : a) -> e b, i@0@10069 : int, yy : list<a>, b) -> e list<b> */  {
...
export function _trmc_unroll_lift_map_indexed_4949_10011(f_1, ys, i, _acc_0) /* forall<a,b,e> (f : (idx : int, value : a) -> e b, ys : list<a>, i : int, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (ys !== null) {
    ...
    var x_10913 = f_1(i, ys.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10416_0 /* 2069 */ ) {
        return _mlift_trmc_unroll_lift_map_indexed_4949_10011_10834(_acc_0, f_1, i_0_10069_1, ys.tail, _trmc_x10416_0);
      });
    }
    else {
      ...
      var _trmc_x10418_0 = $std_core_types.Cons(x_10913, _trmc_x10417_0);
      {
        // tail call
...
export function _trmcm_unroll_lift_map_indexed_4949_10011(f_2, ys_0, i_0, _accm_0) /* forall<a,b,e> (f : (idx : int, value : a) -> e b, ys : list<a>, i : int, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (ys_0 !== null) {
    ...
    var x_0_10916 = f_2(i_0, ys_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10421_0 /* 2069 */ ) {
        return _mlift_trmcm_unroll_lift_map_indexed_4949_10011_10835(_accm_0, f_2, i_0_10069_2, ys_0.tail, _trmc_x10421_0);
      });
    }
    else {
      {
        // tail call
        var _x47 = function(__at_accm_045 /* (list<2069>) -> list<2069> */ , _x_0_1091646 /* 2069 */ ) {
          return function(_trmc_x10420_0 /* list<2069> */ ) {
            return __at_accm_045($std_core_types.Cons(_x_0_1091646, _trmc_x10420_0));
          };
        }(_accm_0, x_0_10916);
        ys_0 = ys_0.tail;
        i_0 = i_0_10069_2;
...
// monadic lift
export function _mlift_trmc_unroll_lift_map_peek_4950_10012_10836(_acc, f, yy, _trmc_x10422) /* forall<a,b,e> (ctx<list<b>>, f : (value : a, rest : list<a>) -> e b, yy : list<a>, b) -> e list<b> */  {
...
// monadic lift
export function _mlift_trmcm_unroll_lift_map_peek_4950_10012_10837(_accm, f_0, yy_0, _trmc_x10427) /* forall<a,b,e> ((list<b>) -> list<b>, f : (value : a, rest : list<a>) -> e b, yy : list<a>, b) -> e list<b> */  {
...
export function _trmc_unroll_lift_map_peek_4950_10012(f_1, ys, _acc_0) /* forall<a,b,e> (f : (value : a, rest : list<a>) -> e b, ys : list<a>, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (ys !== null) {
    ...
    var x_10919 = f_1(ys.head, ys.tail);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10422_0 /* 2121 */ ) {
        return _mlift_trmc_unroll_lift_map_peek_4950_10012_10836(_acc_0, f_1, ys.tail, _trmc_x10422_0);
      });
    }
    else {
      ...
      var _trmc_x10424_0 = $std_core_types.Cons(x_10919, _trmc_x10423_0);
      {
        // tail call
...
export function _trmcm_unroll_lift_map_peek_4950_10012(f_2, ys_0, _accm_0) /* forall<a,b,e> (f : (value : a, rest : list<a>) -> e b, ys : list<a>, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (ys_0 !== null) {
    ...
    var x_0_10922 = f_2(ys_0.head, ys_0.tail);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10427_0 /* 2121 */ ) {
        return _mlift_trmcm_unroll_lift_map_peek_4950_10012_10837(_accm_0, f_2, ys_0.tail, _trmc_x10427_0);
      });
    }
    else {
      {
        // tail call
        var _x52 = function(__at_accm_050 /* (list<2121>) -> list<2121> */ , _x_0_1092251 /* 2121 */ ) {
          return function(_trmc_x10426_0 /* list<2121> */ ) {
            return __at_accm_050($std_core_types.Cons(_x_0_1092251, _trmc_x10426_0));
          };
        }(_accm_0, x_0_10922);
        ys_0 = ys_0.tail;
        _accm_0 = _x52;
...
// monadic lift
export function _mlift_trmc_unroll_lift_map_indexed_peek_4951_10013_10838(_acc, f, i_0_10077, yy, _trmc_x10428) /* forall<a,b,e> (ctx<list<b>>, f : (idx : int, value : a, rest : list<a>) -> e b, i@0@10077 : int, yy : list<a>, b) -> e list<b> */  {
...
// monadic lift
export function _mlift_trmcm_unroll_lift_map_indexed_peek_4951_10013_10839(_accm, f_0, i_0_10077_0, yy_0, _trmc_x10433) /* forall<a,b,e> ((list<b>) -> list<b>, f : (idx : int, value : a, rest : list<a>) -> e b, i@0@10077 : int, yy : list<a>, b) -> e list<b> */  {
...
export function _trmc_unroll_lift_map_indexed_peek_4951_10013(f_1, ys, i, _acc_0) /* forall<a,b,e> (f : (idx : int, value : a, rest : list<a>) -> e b, ys : list<a>, i : int, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (ys !== null) {
    ...
    var x_10925 = f_1(i, ys.head, ys.tail);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10428_0 /* 2183 */ ) {
        return _mlift_trmc_unroll_lift_map_indexed_peek_4951_10013_10838(_acc_0, f_1, i_0_10077_1, ys.tail, _trmc_x10428_0);
      });
    }
    else {
      ...
      var _trmc_x10430_0 = $std_core_types.Cons(x_10925, _trmc_x10429_0);
      {
        // tail call
...
export function _trmcm_unroll_lift_map_indexed_peek_4951_10013(f_2, ys_0, i_0, _accm_0) /* forall<a,b,e> (f : (idx : int, value : a, rest : list<a>) -> e b, ys : list<a>, i : int, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (ys_0 !== null) {
    ...
    var x_0_10928 = f_2(i_0, ys_0.head, ys_0.tail);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_trmc_x10433_0 /* 2183 */ ) {
        return _mlift_trmcm_unroll_lift_map_indexed_peek_4951_10013_10839(_accm_0, f_2, i_0_10077_2, ys_0.tail, _trmc_x10433_0);
      });
    }
    else {
      {
        // tail call
        var _x57 = function(__at_accm_055 /* (list<2183>) -> list<2183> */ , _x_0_1092856 /* 2183 */ ) {
          return function(_trmc_x10432_0 /* list<2183> */ ) {
            return __at_accm_055($std_core_types.Cons(_x_0_1092856, _trmc_x10432_0));
          };
        }(_accm_0, x_0_10928);
        ys_0 = ys_0.tail;
        i_0 = i_0_10077_2;
...
// monadic lift
export function _mlift_trmc_lift_remove_10366_10840(_acc, _uniq_x_10313, _uniq_xx_10314, pred, _y_x10617) /* forall<a,e> (ctx<list<a>>, a, list<a>, pred : (a) -> e bool, bool) -> e list<a> */  {
  if (_y_x10617) {
...
// monadic lift
export function _mlift_trmcm_lift_remove_10366_10841(_accm, _uniq_x_10313_0, _uniq_xx_10314_0, pred_0, _y_x10622) /* forall<a,e> ((list<a>) -> list<a>, a, list<a>, pred : (a) -> e bool, bool) -> e list<a> */  {
  if (_y_x10622) {
...
export function _trmc_lift_remove_10366(pred_1, _uniq_xs_10310, _acc_0) /* forall<a,e> (pred : (a) -> e bool, list<a>, ctx<list<a>>) -> e list<a> */  { tailcall: while(1)
{
  if (_uniq_xs_10310 !== null) {
    ...
    var x_10931 = pred_1(_uniq_xs_10310.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10617_0 /* bool */ ) {
        return _mlift_trmc_lift_remove_10366_10840(_acc_0, _uniq_xs_10310.head, _uniq_xs_10310.tail, pred_1, _y_x10617_0);
      });
    }
    else {
      if (x_10931) {
...
export function _trmcm_lift_remove_10366(pred_2, _uniq_xs_10310_0, _accm_0) /* forall<a,e> (pred : (a) -> e bool, list<a>, (list<a>) -> list<a>) -> e list<a> */  { tailcall: while(1)
{
  if (_uniq_xs_10310_0 !== null) {
    ...
    var x_0_10934 = pred_2(_uniq_xs_10310_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10622_0 /* bool */ ) {
        return _mlift_trmcm_lift_remove_10366_10841(_accm_0, _uniq_xs_10310_0.head, _uniq_xs_10310_0.tail, pred_2, _y_x10622_0);
      });
    }
    else {
      if (x_0_10934) {
...
// monadic lift
export function _mlift_unroll_partition_acc_10014_10842(acc1, acc2, pred, x, xx, _y_x10632) /* forall<a,e> (acc1 : ctx<list<a>>, acc2 : ctx<list<a>>, pred : (a) -> e bool, x : a, xx : list<a>, bool) -> e (list<a>, list<a>) */  {
  if (_y_x10632) {
...
export function _unroll_partition_acc_10014(xs, pred_0, acc1_0, acc2_0) /* forall<a,e> (xs : list<a>, pred : (a) -> e bool, acc1 : ctx<list<a>>, acc2 : ctx<list<a>>) -> e (list<a>, list<a>) */  { tailcall: while(1)
{
  if (xs === null) {
    ...
    var x_1_10937 = pred_0(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10632_0 /* bool */ ) {
        return _mlift_unroll_partition_acc_10014_10842(acc1_0, acc2_0, pred_0, xs.head, xs.tail, _y_x10632_0);
      });
    }
    else {
      if (x_1_10937) {
...
// monadic lift
export function _mlift_lift_lookup_10367_10843(_uniq_x_10324, _uniq_xx_10325, pred, _y_x10641) /* forall<a,b,e> ((a, b), list<(a, b)>, pred : (a) -> e bool, bool) -> e maybe<b> */  {
  if (_y_x10641) {
...
export function _lift_lookup_10367(pred_0, _uniq_xs_10320) /* forall<a,b,e> (pred : (a) -> e bool, list<(a, b)>) -> e maybe<b> */  { tailcall: while(1)
{
  if (_uniq_xs_10320 === null) {
    ...
    var x_10940 = pred_0(_x70);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10641_0 /* bool */ ) {
        return _mlift_lift_lookup_10367_10843(_uniq_xs_10320.head, _uniq_xs_10320.tail, pred_0, _y_x10641_0);
      });
    }
    else {
      if (x_10940) {
...
// monadic lift
export function _mlift_unroll_index_of_acc_10015_10844(idx, pred, xx, _y_x10648) /* forall<a,e> (idx : int, pred : (a) -> e bool, xx : list<a>, bool) -> e int */  {
  if (_y_x10648) {
    return idx;
  }
  else {
...
export function _unroll_index_of_acc_10015(xs, pred_0, idx_0) /* forall<a,e> (xs : list<a>, pred : (a) -> e bool, idx : int) -> e int */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_10943 = pred_0(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10648_0 /* bool */ ) {
        return _mlift_unroll_index_of_acc_10015_10844(idx_0, pred_0, xs.tail, _y_x10648_0);
      });
    }
    else {
      if (x_0_10943) {
...
// monadic lift
export function _mlift_unroll_foreach_10016_10845(action, xx, wild__) /* forall<a,e> (action : (a) -> e (), xx : list<a>, wild_ : ()) -> e () */  {
...
export function _unroll_foreach_10016(xs, action_0) /* forall<a,e> (xs : list<a>, action : (a) -> e ()) -> e () */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_10946 = action_0(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return _mlift_unroll_foreach_10016_10845(action_0, xs.tail, wild___0);
      });
    }
    else {
      {
...
// monadic lift
export function _mlift_trmc_unroll_map_while_10017_10846(_acc, action, xx, _y_x10661) /* forall<a,b,e> (ctx<list<b>>, action : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e list<b> */  {
  if (_y_x10661 !== null) {
     
    var _trmc_x10440 = undefined;
     
    var _trmc_x10441 = $std_core_types.Cons(_y_x10661.value, _trmc_x10440);
...
// monadic lift
export function _mlift_trmcm_unroll_map_while_10017_10847(_accm, action_0, xx_0, _y_x10665) /* forall<a,b,e> ((list<b>) -> list<b>, action : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e list<b> */  {
  if (_y_x10665 !== null) {
    return _trmcm_unroll_map_while_10017(xx_0, action_0, function(_trmc_x10443 /* list<2754> */ ) {
        return _accm($std_core_types.Cons(_y_x10665.value, _trmc_x10443));
      });
  }
  else {
...
export function _trmc_unroll_map_while_10017(xs, action_1, _acc_0) /* forall<a,b,e> (xs : list<a>, action : (a) -> e maybe<b>, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (xs === null) {
    ...
    var x_0_10949 = action_1(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10661_0 /* maybe<2754> */ ) {
        return _mlift_trmc_unroll_map_while_10017_10846(_acc_0, action_1, xs.tail, _y_x10661_0);
      });
    }
    else {
      if (x_0_10949 !== null) {
        ...
        var _trmc_x10441_0 = $std_core_types.Cons(x_0_10949.value, _trmc_x10440_0);
        {
          // tail call
...
export function _trmcm_unroll_map_while_10017(xs_0, action_2, _accm_0) /* forall<a,b,e> (xs : list<a>, action : (a) -> e maybe<b>, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (xs_0 === null) {
    ...
    var x_2_10952 = action_2(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10665_0 /* maybe<2754> */ ) {
        return _mlift_trmcm_unroll_map_while_10017_10847(_accm_0, action_2, xs_0.tail, _y_x10665_0);
      });
    }
    else {
      if (x_2_10952 !== null) {
...
// monadic lift
export function _mlift_lift_foreach_indexed_10368_10848(_uniq_xx_10334, action, i, _uniq_x___10335) /* forall<h,a,e> (list<a>, action : (int, a) -> e (), i : local-var<h,int>, ()) -> <local<h>|e> () */  {
  return _lift_foreach_indexed_10368(action, i, _uniq_xx_10334);
}
 
 
// monadic lift
export function _mlift_lift_foreach_indexed_10368_10849(_uniq_xx_10334_0, action_0, i_0, _y_x10677) /* forall<h,a,e> (list<a>, action : (int, a) -> e (), i : local-var<h,int>, int) -> <local<h>|e> () */  {
   
  var x_10955 = ((i_0).value = ($std_core_types._int_add(_y_x10677,1)));
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_uniq_x___10335_0 /* () */ ) {
      return _mlift_lift_foreach_indexed_10368_10848(_uniq_xx_10334_0, action_0, i_0, _uniq_x___10335_0);
    });
  }
  else {
    return _mlift_lift_foreach_indexed_10368_10848(_uniq_xx_10334_0, action_0, i_0, x_10955);
  }
}
 
 
// monadic lift
export function _mlift_lift_foreach_indexed_10368_10850(_uniq_xx_10334_1, action_1, i_1, wild__) /* forall<h,a,e> (list<a>, action : (int, a) -> e (), i : local-var<h,int>, wild_ : ()) -> <local<h>|e> () */  {
   
  var x_0_10957 = ((i_1).value);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10677_0 /* int */ ) {
      return _mlift_lift_foreach_indexed_10368_10849(_uniq_xx_10334_1, action_1, i_1, _y_x10677_0);
    });
  }
  else {
    return _mlift_lift_foreach_indexed_10368_10849(_uniq_xx_10334_1, action_1, i_1, x_0_10957);
  }
}
 
 
// monadic lift
export function _mlift_lift_foreach_indexed_10368_10851(_uniq_x_10333, _uniq_xx_10334_2, action_2, i_2, j) /* forall<h,a,e> (a, list<a>, action : (int, a) -> e (), i : local-var<h,int>, j : int) -> <local<h>|e> () */  {
   
  var x_1_10959 = action_2(j, _uniq_x_10333);
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
      return _mlift_lift_foreach_indexed_10368_10850(_uniq_xx_10334_2, action_2, i_2, wild___0);
    });
  }
  else {
    return _mlift_lift_foreach_indexed_10368_10850(_uniq_xx_10334_2, action_2, i_2, x_1_10959);
  }
}
...
export function _lift_foreach_indexed_10368(action_4, i_3, _uniq_xs_10330) /* forall<h,a,e> (action : (int, a) -> e (), i : local-var<h,int>, list<a>) -> <local<h>|e> () */  { tailcall: while(1)
{
  if (_uniq_xs_10330 !== null) {
    ...
    var x_2_10962 = ((i_3).value);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(j_0 /* int */ ) {
        return _mlift_lift_foreach_indexed_10368_10851(_uniq_xs_10330.head, _uniq_xs_10330.tail, action_4, i_3, j_0);
      });
    }
    else {
       
      var x_3_10965 = action_4(x_2_10962, _uniq_xs_10330.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild___1 /* () */ ) {
          return _mlift_lift_foreach_indexed_10368_10850(_uniq_xs_10330.tail, action_4, i_3, wild___1);
        });
      }
      else {
         
        var x_4_10969 = ((i_3).value);
        if ($std_core_hnd._yielding()) {
          return $std_core_hnd.yield_extend(function(_y_x10677_1 /* int */ ) {
            return _mlift_lift_foreach_indexed_10368_10849(_uniq_xs_10330.tail, action_4, i_3, _y_x10677_1);
          });
        }
        else {
           
          var x_5_10972 = ((i_3).value = ($std_core_types._int_add(x_4_10969,1)));
          if ($std_core_hnd._yielding()) {
            return $std_core_hnd.yield_extend(function(_uniq_x___10335_1 /* () */ ) {
              return _mlift_lift_foreach_indexed_10368_10848(_uniq_xs_10330.tail, action_4, i_3, _uniq_x___10335_1);
            });
          }
          else {
            {
...
// monadic lift
export function _mlift_show_10852(_c_x10686) /* (list<string>) -> string */  {
  match: {
    if (_c_x10686 === null) {
      var _x80 = "";
      break match;
    }
    if (_c_x10686 !== null && _c_x10686.tail === null) {
      var _x80 = _c_x10686.head;
      break match;
    }
    if (_c_x10686 !== null && _c_x10686.tail !== null && _c_x10686.tail.tail === null) {
      if (((",") === (""))){
        var _x80 = $std_core_types._lp__plus__plus__rp_(_c_x10686.head, _c_x10686.tail.head);
        break match;
      }
    }
    var _x80 = ((($std_core_vector.unvlist(_c_x10686))).join((",")));
  }
...
export function show(xs, _implicit_fs_show) /* forall<a,e> (xs : list<a>, ?show : (a) -> e string) -> e string */  {
  ...
  if (xs === null) {
    var x_10977 = $std_core_types.Nil;
  }
  else {
    var x_10977 = _unroll_map_10010(xs, _implicit_fs_show);
  }
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(_mlift_show_10852);
  }
  else {
    match: {
      if (x_10977 === null) {
      ...
      if (x_10977 !== null && x_10977.tail === null) {
        var _x81 = x_10977.head;
        break match;
      }
      if (x_10977 !== null && x_10977.tail !== null && x_10977.tail.tail === null) {
        if (((",") === (""))){
          var _x81 = $std_core_types._lp__plus__plus__rp_(x_10977.head, x_10977.tail.head);
          break match;
        }
      }
      var _x81 = ((($std_core_vector.unvlist(x_10977))).join((",")));
    }
...
// monadic lift
export function _mlift_trmc_unroll_zipwith_10020_10853(_acc, f, xx, yy, _trmc_x10448) /* forall<a,b,c,e> (ctx<list<c>>, f : (a, b) -> e c, xx : list<a>, yy : list<b>, c) -> e list<c> */  {
...
// monadic lift
export function _mlift_trmcm_unroll_zipwith_10020_10854(_accm, f_0, xx_0, yy_0, _trmc_x10453) /* forall<a,b,c,e> ((list<c>) -> list<c>, f : (a, b) -> e c, xx : list<a>, yy : list<b>, c) -> e list<c> */  {
...
export function _trmc_unroll_zipwith_10020(xs, ys, f_1, _acc_0) /* forall<a,b,c,e> (xs : list<a>, ys : list<b>, f : (a, b) -> e c, ctx<list<c>>) -> e list<c> */  { tailcall: while(1)
{
  if (xs !== null) {
    if (ys !== null) {
      ...
      var x_0_10980 = f_1(xs.head, ys.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_trmc_x10448_0 /* 3290 */ ) {
          return _mlift_trmc_unroll_zipwith_10020_10853(_acc_0, f_1, xs.tail, ys.tail, _trmc_x10448_0);
        });
      }
      else {
        ...
        var _trmc_x10450_0 = $std_core_types.Cons(x_0_10980, _trmc_x10449_0);
        {
          // tail call
...
export function _trmcm_unroll_zipwith_10020(xs_0, ys_0, f_2, _accm_0) /* forall<a,b,c,e> (xs : list<a>, ys : list<b>, f : (a, b) -> e c, (list<c>) -> list<c>) -> e list<c> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    if (ys_0 !== null) {
      ...
      var x_2_10983 = f_2(xs_0.head, ys_0.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_trmc_x10453_0 /* 3290 */ ) {
          return _mlift_trmcm_unroll_zipwith_10020_10854(_accm_0, f_2, xs_0.tail, ys_0.tail, _trmc_x10453_0);
        });
      }
      else {
        {
          // tail call
          var _x86 = function(__at_accm_084 /* (list<3290>) -> list<3290> */ , _x_2_1098385 /* 3290 */ ) {
            return function(_trmc_x10452_0 /* list<3290> */ ) {
              return __at_accm_084($std_core_types.Cons(_x_2_1098385, _trmc_x10452_0));
            };
          }(_accm_0, x_2_10983);
          xs_0 = xs_0.tail;
          ys_0 = ys_0.tail;
...
// monadic lift
export function _mlift_trmc_unroll_lift_zipwith_indexed_4953_10021_10855(_acc, f, i_0_10105, xx, yy, _trmc_x10454) /* forall<a,b,c,e> (ctx<list<c>>, f : (int, a, b) -> e c, i@0@10105 : int, xx : list<a>, yy : list<b>, c) -> e list<c> */  {
...
// monadic lift
export function _mlift_trmcm_unroll_lift_zipwith_indexed_4953_10021_10856(_accm, f_0, i_0_10105_0, xx_0, yy_0, _trmc_x10459) /* forall<a,b,c,e> ((list<c>) -> list<c>, f : (int, a, b) -> e c, i@0@10105 : int, xx : list<a>, yy : list<b>, c) -> e list<c> */  {
...
export function _trmc_unroll_lift_zipwith_indexed_4953_10021(f_1, i, xs, ys, _acc_0) /* forall<a,b,c,e> (f : (int, a, b) -> e c, i : int, xs : list<a>, ys : list<b>, ctx<list<c>>) -> e list<c> */  { tailcall: while(1)
{
  if (xs !== null) {
    if (ys !== null) {
      ...
      var x_0_10986 = f_1(i, xs.head, ys.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_trmc_x10454_0 /* 3373 */ ) {
          return _mlift_trmc_unroll_lift_zipwith_indexed_4953_10021_10855(_acc_0, f_1, i_0_10105_1, xs.tail, ys.tail, _trmc_x10454_0);
        });
      }
      else {
        ...
        var _trmc_x10456_0 = $std_core_types.Cons(x_0_10986, _trmc_x10455_0);
        {
          // tail call
...
export function _trmcm_unroll_lift_zipwith_indexed_4953_10021(f_2, i_0, xs_0, ys_0, _accm_0) /* forall<a,b,c,e> (f : (int, a, b) -> e c, i : int, xs : list<a>, ys : list<b>, (list<c>) -> list<c>) -> e list<c> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    if (ys_0 !== null) {
      ...
      var x_2_10989 = f_2(i_0, xs_0.head, ys_0.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_trmc_x10459_0 /* 3373 */ ) {
          return _mlift_trmcm_unroll_lift_zipwith_indexed_4953_10021_10856(_accm_0, f_2, i_0_10105_2, xs_0.tail, ys_0.tail, _trmc_x10459_0);
        });
      }
      else {
        {
          // tail call
          var _x91 = function(__at_accm_089 /* (list<3373>) -> list<3373> */ , _x_2_1098990 /* 3373 */ ) {
            return function(_trmc_x10458_0 /* list<3373> */ ) {
              return __at_accm_089($std_core_types.Cons(_x_2_1098990, _trmc_x10458_0));
            };
          }(_accm_0, x_2_10989);
          i_0 = i_0_10105_2;
          xs_0 = xs_0.tail;
...
// monadic lift
export function _mlift_unroll_lift_span_4957_10025_10857(acc, predicate, y, ys, yy, _y_x10716) /* forall<a,e> (acc : list<a>, predicate : (a) -> e bool, y : a, ys : list<a>, yy : list<a>, bool) -> e (list<a>, list<a>) */  {
  if (_y_x10716) {
...
export function _unroll_lift_span_4957_10025(predicate_0, ys_0, acc_0) /* forall<a,e> (predicate : (a) -> e bool, ys : list<a>, acc : list<a>) -> e (list<a>, list<a>) */  { tailcall: while(1)
{
  if (ys_0 !== null) {
    ...
    var x_10992 = predicate_0(ys_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10716_0 /* bool */ ) {
        return _mlift_unroll_lift_span_4957_10025_10857(acc_0, predicate_0, ys_0.head, ys_0, ys_0.tail, _y_x10716_0);
      });
    }
    else {
      if (x_10992) {
...
// monadic lift
export function _mlift_trmc_unroll_take_while_10026_10858(_acc, predicate, x, xx, _y_x10724) /* forall<a,e> (ctx<list<a>>, predicate : (a) -> e bool, x : a, xx : list<a>, bool) -> e list<a> */  {
  if (_y_x10724) {
...
// monadic lift
export function _mlift_trmcm_unroll_take_while_10026_10859(_accm, predicate_0, x_0, xx_0, _y_x10728) /* forall<a,e> ((list<a>) -> list<a>, predicate : (a) -> e bool, x : a, xx : list<a>, bool) -> e list<a> */  {
  if (_y_x10728) {
...
export function _trmc_unroll_take_while_10026(xs, predicate_1, _acc_0) /* forall<a,e> (xs : list<a>, predicate : (a) -> e bool, ctx<list<a>>) -> e list<a> */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_2_10995 = predicate_1(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10724_0 /* bool */ ) {
        return _mlift_trmc_unroll_take_while_10026_10858(_acc_0, predicate_1, xs.head, xs.tail, _y_x10724_0);
      });
    }
    else {
      if (x_2_10995) {
...
export function _trmcm_unroll_take_while_10026(xs_0, predicate_2, _accm_0) /* forall<a,e> (xs : list<a>, predicate : (a) -> e bool, (list<a>) -> list<a>) -> e list<a> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    ...
    var x_4_10998 = predicate_2(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10728_0 /* bool */ ) {
        return _mlift_trmcm_unroll_take_while_10026_10859(_accm_0, predicate_2, xs_0.head, xs_0.tail, _y_x10728_0);
      });
    }
    else {
      if (x_4_10998) {
...
// monadic lift
export function _mlift_trmc_lift_flatmap_4959_10860(_acc, f, zz, ys_1_10132) /* forall<a,b,e> (ctx<list<b>>, f : (a) -> e list<b>, zz : list<a>, ys@1@10132 : list<b>) -> e list<b> */  {
  return _trmc_lift_flatmap_4959(f, ys_1_10132, zz, _acc);
}
 
 
// monadic lift
export function _mlift_trmcm_lift_flatmap_4959_10861(_accm, f_0, zz_0, ys_1_10132_0) /* forall<a,b,e> ((list<b>) -> list<b>, f : (a) -> e list<b>, zz : list<a>, ys@1@10132 : list<b>) -> e list<b> */  {
...
export function _trmc_lift_flatmap_4959(f_1, ys, zs, _acc_0) /* forall<a,b,e> (f : (a) -> e list<b>, ys : list<b>, zs : list<a>, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (ys !== null) {
    ...
    if (zs !== null) {
      ...
      var x_11001 = f_1(zs.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(ys_1_10132_1 /* list<4487> */ ) {
          return _mlift_trmc_lift_flatmap_4959_10860(_acc_0, f_1, zs.tail, ys_1_10132_1);
        });
      }
      else {
        {
...
export function _trmcm_lift_flatmap_4959(f_2, ys_0, zs_0, _accm_0) /* forall<a,b,e> (f : (a) -> e list<b>, ys : list<b>, zs : list<a>, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (ys_0 !== null) {
    ...
    if (zs_0 !== null) {
      ...
      var x_0_11004 = f_2(zs_0.head);
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(ys_1_10132_3 /* list<4487> */ ) {
          return _mlift_trmcm_lift_flatmap_4959_10861(_accm_0, f_2, zs_0.tail, ys_1_10132_3);
        });
      }
      else {
        {
...
// monadic lift
export function _mlift_trmc_unroll_flatmap_maybe_10027_10862(_acc, f, xx, _y_x10751) /* forall<a,b,e> (ctx<list<b>>, f : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e list<b> */  {
  if (_y_x10751 !== null) {
     
    var _trmc_x10470 = undefined;
     
    var _trmc_x10471 = $std_core_types.Cons(_y_x10751.value, _trmc_x10470);
...
// monadic lift
export function _mlift_trmcm_unroll_flatmap_maybe_10027_10863(_accm, f_0, xx_0, _y_x10756) /* forall<a,b,e> ((list<b>) -> list<b>, f : (a) -> e maybe<b>, xx : list<a>, maybe<b>) -> e list<b> */  {
  if (_y_x10756 !== null) {
    return _trmcm_unroll_flatmap_maybe_10027(xx_0, f_0, function(_trmc_x10473 /* list<4558> */ ) {
        return _accm($std_core_types.Cons(_y_x10756.value, _trmc_x10473));
      });
  }
  else {
...
export function _trmc_unroll_flatmap_maybe_10027(xs, f_1, _acc_0) /* forall<a,b,e> (xs : list<a>, f : (a) -> e maybe<b>, ctx<list<b>>) -> e list<b> */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_11007 = f_1(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10751_0 /* maybe<4558> */ ) {
        return _mlift_trmc_unroll_flatmap_maybe_10027_10862(_acc_0, f_1, xs.tail, _y_x10751_0);
      });
    }
    else {
      if (x_0_11007 !== null) {
        ...
        var _trmc_x10471_0 = $std_core_types.Cons(x_0_11007.value, _trmc_x10470_0);
        {
          // tail call
...
export function _trmcm_unroll_flatmap_maybe_10027(xs_0, f_2, _accm_0) /* forall<a,b,e> (xs : list<a>, f : (a) -> e maybe<b>, (list<b>) -> list<b>) -> e list<b> */  { tailcall: while(1)
{
  if (xs_0 !== null) {
    ...
    var x_2_11010 = f_2(xs_0.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10756_0 /* maybe<4558> */ ) {
        return _mlift_trmcm_unroll_flatmap_maybe_10027_10863(_accm_0, f_2, xs_0.tail, _y_x10756_0);
      });
    }
    else {
      if (x_2_11010 !== null) {
...
// monadic lift
export function _mlift_unroll_all_10030_10864(predicate, xx, _y_x10766) /* forall<a,e> (predicate : (a) -> e bool, xx : list<a>, bool) -> e bool */  {
  if (_y_x10766) {
...
export function _unroll_all_10030(xs, predicate_0) /* forall<a,e> (xs : list<a>, predicate : (a) -> e bool) -> e bool */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_11013 = predicate_0(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10766_0 /* bool */ ) {
        return _mlift_unroll_all_10030_10864(predicate_0, xs.tail, _y_x10766_0);
      });
    }
    else {
      if (x_0_11013) {
...
// monadic lift
export function _mlift_unroll_any_10031_10865(predicate, xx, _y_x10772) /* forall<a,e> (predicate : (a) -> e bool, xx : list<a>, bool) -> e bool */  {
  if (_y_x10772) {
    return true;
  }
  else {
...
export function _unroll_any_10031(xs, predicate_0) /* forall<a,e> (xs : list<a>, predicate : (a) -> e bool) -> e bool */  { tailcall: while(1)
{
  if (xs !== null) {
    ...
    var x_0_11016 = predicate_0(xs.head);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10772_0 /* bool */ ) {
        return _mlift_unroll_any_10031_10865(predicate_0, xs.tail, _y_x10772_0);
      });
    }
    else {
      if (x_0_11016) {
