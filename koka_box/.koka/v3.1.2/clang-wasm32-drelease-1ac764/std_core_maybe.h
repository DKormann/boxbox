...
static inline kk_box_t kk_std_core_maybe_unjust(kk_std_core_types__maybe m, kk_context_t* _ctx) { /* forall<a> (m : maybe<a>) -> exn a */ 
  ...
  {
    kk_string_t _x_x29;
    kk_define_string_literal(, _s_x30, 43, "unexpected Nothing in std/core/maybe/unjust", _ctx)
    _x_x29 = kk_string_dup(_s_x30, _ctx); /*string*/
    return kk_std_core_exn_throw(_x_x29, kk_std_core_types__new_None(_ctx), _ctx);
  }
}
 
// monadic lift

static inline kk_std_core_types__maybe kk_std_core_maybe__mlift_map_10108(kk_box_t _y_x10104, kk_context_t* _ctx) { /* forall<a,e> (a) -> e maybe<a> */ 
  return kk_std_core_types__new_Just(_y_x10104, _ctx);
}
...
static inline kk_string_t kk_std_core_maybe__mlift_show_10109(kk_string_t _y_x10106, kk_context_t* _ctx) { /* forall<e> (string) -> e string */ 
  kk_string_t _x_x47;
  ...
  _x_x49 = kk_std_core_types__lp__plus__plus__rp_(_y_x10106, _x_x50, _ctx); /*string*/
