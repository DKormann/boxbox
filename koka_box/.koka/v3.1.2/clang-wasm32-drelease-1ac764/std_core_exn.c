// Koka generated module: std/core/exn, koka version: 3.1.2, platform: 32-bit
...
kk_box_t kk_std_core_exn_throw(kk_string_t message, kk_std_core_types__optional info, kk_context_t* _ctx) { /* forall<a> (message : string, info : ? exception-info) -> exn a */ 
  ...
  {
    struct kk_std_core_hnd_Ev* _con_x110 = kk_std_core_hnd__as_Ev(ev_10133, _ctx);
    ...
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x22, (_fun_unbox_x22, m, ev_10133, _x_x112, _ctx), _ctx);
      }
    }
  }
}
...
kk_box_t kk_std_core_exn_error_pattern(kk_string_t location, kk_string_t definition, kk_context_t* _ctx) { /* forall<a> (location : string, definition : string) -> exn a */ 
  ...
  {
    struct kk_std_core_hnd_Ev* _con_x123 = kk_std_core_hnd__as_Ev(ev_10136, _ctx);
    ...
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x31, (_fun_unbox_x31, m, ev_10136, _x_x125, _ctx), _ctx);
      }
    }
  }
}
...
static kk_box_t kk_std_core_exn_try_fun149(kk_function_t _fself, kk_box_t _b_x49, kk_context_t* _ctx) {
  kk_unused(_fself);
  kk_box_t _y_x10120_63 = _b_x49; /*677*/;
  kk_std_core_exn__error _x_x150 = kk_std_core_exn__new_Ok(_y_x10120_63, _ctx); /*error<6>*/
...
static kk_box_t kk_std_core_exn_try_fun146(kk_function_t _fself, kk_context_t* _ctx) {
  ...
  kk_box_t x_0_10141 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*677*/;
  ...
  if (kk_yielding(kk_context())) {
    ...
    _x_x147 = kk_std_core_exn__new_Ok(x_0_10141, _ctx); /*error<677>*/
  }
...
kk_box_t kk_std_core_exn_untry(kk_std_core_exn__error err, kk_context_t* _ctx) { /* forall<a> (err : error<a>) -> exn a */ 
  if (kk_std_core_exn__is_Error(err, _ctx)) {
    ...
    {
      struct kk_std_core_hnd_Ev* _con_x158 = kk_std_core_hnd__as_Ev(ev_10145, _ctx);
...
kk_box_t kk_std_core_exn_exn_error_range(kk_context_t* _ctx) { /* forall<a> () -> exn a */ 
  ...
  {
    struct kk_std_core_hnd_Ev* _con_x161 = kk_std_core_hnd__as_Ev(ev_10150, _ctx);
    ...
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x83, (_fun_unbox_x83, m, ev_10150, _x_x163, _ctx), _ctx);
      }
    }
  }
}
