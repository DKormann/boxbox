...
static inline kk_box_t kk_std_core_delayed__mlift_force_10110(kk_ref_t r, kk_box_t x_0, kk_context_t* _ctx) { /* forall<a,e> (r : ref<global,either<() -> e a,a>>, x@0 : a) -> <st<global>,div|e> a */ 
