...
kk_unit_t kk_std_core_debug_trace_show(kk_box_t x, kk_function_t _implicit_fs_show, kk_string_t _implicit_fs_kk_file_line, kk_context_t* _ctx) { /* forall<a> (x : a, ?show : (a) -> string, ?kk-file-line : string) -> () */ 
  ...
  _x_x31 = kk_std_core_types__lp__plus__plus__rp_(_x_x32, message_10006, _ctx); /*string*/
  message_0_10002 = kk_std_core_types__lp__plus__plus__rp_(_implicit_fs_kk_file_line, _x_x31, _ctx); /*string*/
  bool _match_x15;
  kk_box_t _x_x34;
