...
static inline bool kk_std_core_list__lp__eq__eq__rp_(kk_std_core_types__list xs, kk_std_core_types__list ys, kk_function_t _implicit_fs__lp__eq__eq__rp_, kk_context_t* _ctx) { /* forall<a> (xs : list<a>, ys : list<a>, ?(==) : (a, a) -> bool) -> bool */ 
  if (kk_std_core_types__is_Nil(xs, _ctx)) {
    ...
    {
      struct kk_std_core_types_Cons* _con_x1313 = kk_std_core_types__as_Cons(ys, _ctx);
      kk_box_t _pat_7 = _con_x1313->head;
      kk_std_core_types__list _pat_8 = _con_x1313->tail;
...
static inline kk_std_core_types__order kk_std_core_list_cmp(kk_std_core_types__list xs, kk_std_core_types__list ys, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (xs : list<a>, ys : list<a>, ?cmp : (a, a) -> order) -> order */ 
  if (kk_std_core_types__is_Nil(xs, _ctx)) {
    ...
    {
      struct kk_std_core_types_Cons* _con_x1318 = kk_std_core_types__as_Cons(ys, _ctx);
      kk_box_t _pat_6 = _con_x1318->head;
      kk_std_core_types__list _pat_7 = _con_x1318->tail;
      if kk_likely(kk_datatype_ptr_is_unique(ys, _ctx)) {
...
static inline kk_std_core_types__list kk_std_core_list_char_fs_list(kk_char_t lo, kk_char_t hi, kk_context_t* _ctx) { /* (lo : char, hi : char) -> list<char> */ 
  ...
  kk_integer_t _x_x1415 = kk_integer_from_int(lo,kk_context()); /*int*/
  kk_integer_t _x_x1416 = kk_integer_from_int(hi,kk_context()); /*int*/
  xs_10062 = kk_std_core_list_list(_x_x1415, _x_x1416, _ctx); /*list<int>*/
...
static inline kk_std_core_types__tuple2 kk_std_core_list_partition_acc(kk_std_core_types__list xs, kk_function_t pred, kk_std_core_types__cctx acc1, kk_std_core_types__cctx acc2, kk_context_t* _ctx) { /* forall<a,e> (xs : list<a>, pred : (a) -> e bool, acc1 : ctx<list<a>>, acc2 : ctx<list<a>>) -> e (list<a>, list<a>) */ 
  if (kk_std_core_types__is_Nil(xs, _ctx)) {
    kk_std_core_types__list _b_x507_509;
    kk_box_t _x_x1518 = kk_cctx_apply(acc1,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    _b_x507_509 = kk_std_core_types__list_unbox(_x_x1518, KK_OWNED, _ctx); /*list<2413>*/
    kk_std_core_types__list _b_x508_510;
    kk_box_t _x_x1519 = kk_cctx_apply(acc2,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    _b_x508_510 = kk_std_core_types__list_unbox(_x_x1519, KK_OWNED, _ctx); /*list<2413>*/
    return kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(_b_x507_509, _ctx), kk_std_core_types__list_box(_b_x508_510, _ctx), _ctx);
  }
  {
...
static inline kk_std_core_types__tuple2 kk_std_core_list__lift_unzip_4954(kk_std_core_types__list ys, kk_std_core_types__cctx acc1, kk_std_core_types__cctx acc2, kk_context_t* _ctx) { /* forall<a,b,c,d> (ys : list<(a, b)>, acc1 : cctx<c,list<a>>, acc2 : cctx<d,list<b>>) -> (c, d) */ 
  if (kk_std_core_types__is_Nil(ys, _ctx)) {
    kk_box_t _x_x1690 = kk_cctx_apply(acc1,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    kk_box_t _x_x1691 = kk_cctx_apply(acc2,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    return kk_std_core_types__new_Tuple2(_x_x1690, _x_x1691, _ctx);
  }
  {
...
static inline kk_std_core_types__tuple3 kk_std_core_list__lift_unzip3_4955(kk_std_core_types__list ys, kk_std_core_types__cctx acc1, kk_std_core_types__cctx acc2, kk_std_core_types__cctx acc3, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,b1> (ys : list<(a, b, c)>, acc1 : cctx<d,list<a>>, acc2 : cctx<a1,list<b>>, acc3 : cctx<b1,list<c>>) -> (d, a1, b1) */ 
  if (kk_std_core_types__is_Nil(ys, _ctx)) {
    kk_box_t _x_x1707 = kk_cctx_apply(acc1,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    kk_box_t _x_x1708 = kk_cctx_apply(acc2,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    kk_box_t _x_x1709 = kk_cctx_apply(acc3,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    return kk_std_core_types__new_Tuple3(_x_x1707, _x_x1708, _x_x1709, _ctx);
  }
  {
...
static inline kk_std_core_types__tuple4 kk_std_core_list__lift_unzip4_4956(kk_std_core_types__list ys, kk_std_core_types__cctx acc1, kk_std_core_types__cctx acc2, kk_std_core_types__cctx acc3, kk_std_core_types__cctx acc4, kk_context_t* _ctx) { /* forall<a,b,c,d,a1,b1,c1,d1> (ys : list<(a, b, c, d)>, acc1 : cctx<a1,list<a>>, acc2 : cctx<b1,list<b>>, acc3 : cctx<c1,list<c>>, acc4 : cctx<d1,list<d>>) -> (a1, b1, c1, d1) */ 
  if (kk_std_core_types__is_Nil(ys, _ctx)) {
    kk_box_t _x_x1731 = kk_cctx_apply(acc1,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    kk_box_t _x_x1732 = kk_cctx_apply(acc2,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    kk_box_t _x_x1733 = kk_cctx_apply(acc3,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    kk_box_t _x_x1734 = kk_cctx_apply(acc4,(kk_std_core_types__list_box(kk_std_core_types__new_Nil(_ctx), _ctx)),kk_context()); /*359*/
    return kk_std_core_types__new_Tuple4(kk_reuse_null, 0, _x_x1731, _x_x1732, _x_x1733, _x_x1734, _ctx);
  }
  {
...
static inline kk_std_core_types__tuple2 kk_std_core_list__lift_span_4957(kk_function_t predicate, kk_std_core_types__list ys, kk_std_core_types__list acc, kk_context_t* _ctx) { /* forall<a,e> (predicate : (a) -> e bool, ys : list<a>, acc : list<a>) -> e (list<a>, list<a>) */ 
  if (kk_std_core_types__is_Nil(ys, _ctx)) {
    kk_function_drop(predicate, _ctx);
    kk_std_core_types__list _b_x995_997;
    if (kk_std_core_types__is_Nil(acc, _ctx)) {
      _b_x995_997 = kk_std_core_types__new_Nil(_ctx); /*list<4264>*/
    }
    else {
      _b_x995_997 = kk_std_core_list__unroll_lift_reverse_append_4948_10003(kk_std_core_types__new_Nil(_ctx), acc, _ctx); /*list<4264>*/
    }
    return kk_std_core_types__new_Tuple2(kk_std_core_types__list_box(_b_x995_997, _ctx), kk_std_core_types__list_box(ys, _ctx), _ctx);
  }
  {
...
static inline kk_string_t kk_std_core_list_join_end(kk_std_core_types__list xs, kk_string_t end, kk_context_t* _ctx) { /* (xs : list<string>, end : string) -> string */ 
  ...
  }
  {
    ...
    kk_string_t _x_x1766 = kk_string_dup(end, _ctx); /*string*/
    _x_x1765 = kk_std_core_list_joinsep(xs, _x_x1766, _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(_x_x1765, end, _ctx);
  }
}
...
static inline kk_std_core_types__list kk_std_core_list_lines(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> list<string> */ 
  ...
  kk_define_string_literal(, _s_x1822, 1, "\n", _ctx)
  _x_x1821 = kk_string_dup(_s_x1822, _ctx); /*string*/
  v_10013 = kk_string_splitv(s,_x_x1821,kk_context()); /*vector<string>*/
