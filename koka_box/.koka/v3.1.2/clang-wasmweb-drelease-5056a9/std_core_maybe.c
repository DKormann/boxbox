// Koka generated module: std/core/maybe, koka version: 3.1.2, platform: 32-bit
#include "std_core_maybe.h"


// lift anonymous function
struct kk_std_core_maybe_map_fun32__t {
  struct kk_function_s _base;
};
static kk_box_t kk_std_core_maybe_map_fun32(kk_function_t _fself, kk_box_t _b_x1, kk_context_t* _ctx);
static kk_function_t kk_std_core_maybe_new_map_fun32(kk_context_t* _ctx) {
  kk_define_static_function(_fself, kk_std_core_maybe_map_fun32, _ctx)
  return kk_function_dup(_fself,kk_context());
}

static kk_box_t kk_std_core_maybe_map_fun32(kk_function_t _fself, kk_box_t _b_x1, kk_context_t* _ctx) {
  kk_unused(_fself);
  kk_box_t _y_x10104_3 = _b_x1; /*183*/;
  kk_std_core_types__maybe _x_x33 = kk_std_core_types__new_Just(_y_x10104_3, _ctx); /*maybe<1264>*/
  return kk_std_core_types__maybe_box(_x_x33, _ctx);
}
...
kk_std_core_types__maybe kk_std_core_maybe_map(kk_std_core_types__maybe m, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (m : maybe<a>, f : (a) -> e b) -> e maybe<b> */ 
  ...
  }
  {
    ...
    kk_box_t x_0_10110 = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), f, (f, x, _ctx), _ctx); /*183*/;
    if (kk_yielding(kk_context())) {
      kk_box_drop(x_0_10110, _ctx);
      kk_box_t _x_x31 = kk_std_core_hnd_yield_extend(kk_std_core_maybe_new_map_fun32(_ctx), _ctx); /*2978*/
      return kk_std_core_types__maybe_unbox(_x_x31, KK_OWNED, _ctx);
    }
    {
      return kk_std_core_types__new_Just(x_0_10110, _ctx);
    }
  }
}
...
kk_std_core_types__order2 kk_std_core_maybe_order2(kk_std_core_types__maybe mb1, kk_std_core_types__maybe mb2, kk_function_t _implicit_fs_order2, kk_context_t* _ctx) { /* forall<a> (mb1 : maybe<a>, mb2 : maybe<a>, ?order2 : (a, a) -> order2<a>) -> order2<maybe<a>> */ 
  if (kk_std_core_types__is_Just(mb1, _ctx)) {
    ...
    if (kk_std_core_types__is_Just(mb2, _ctx)) {
      ...
      kk_function_t _x_x34 = kk_function_dup(_implicit_fs_order2, _ctx); /*(414, 414) -> order2<414>*/
      _match_x27 = kk_function_call(kk_std_core_types__order2, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _x_x34, (_x_x34, x, y, _ctx), _ctx); /*order2<414>*/
      if (kk_std_core_types__is_Eq2(_match_x27, _ctx)) {
        kk_box_t z = _match_x27._cons.Eq2.eq;
        kk_box_t _x_x35;
        kk_std_core_types__maybe _x_x36 = kk_std_core_types__new_Just(z, _ctx); /*maybe<1421>*/
        _x_x35 = kk_std_core_types__maybe_box(_x_x36, _ctx); /*102*/
      ...
      if (kk_std_core_types__is_Lt2(_match_x27, _ctx)) {
        ...
        kk_box_t _x_x37;
        kk_std_core_types__maybe _x_x38 = kk_std_core_types__new_Just(l, _ctx); /*maybe<1444>*/
        _x_x37 = kk_std_core_types__maybe_box(_x_x38, _ctx); /*102*/
        kk_box_t _x_x39;
        kk_std_core_types__maybe _x_x40 = kk_std_core_types__new_Just(g, _ctx); /*maybe<1444>*/
        _x_x39 = kk_std_core_types__maybe_box(_x_x40, _ctx); /*102*/
      ...
      }
      {
        ...
        kk_box_t _x_x41;
        kk_std_core_types__maybe _x_x42 = kk_std_core_types__new_Just(l_0, _ctx); /*maybe<1467>*/
        _x_x41 = kk_std_core_types__maybe_box(_x_x42, _ctx); /*102*/
        kk_box_t _x_x43;
        kk_std_core_types__maybe _x_x44 = kk_std_core_types__new_Just(g_0, _ctx); /*maybe<1467>*/
        _x_x43 = kk_std_core_types__maybe_box(_x_x44, _ctx); /*102*/
        return kk_std_core_types__new_Gt2(_x_x41, _x_x43, _ctx);
      }
    }
    {
      kk_box_t _x_x45;
      kk_std_core_types__maybe _x_x46 = kk_std_core_types__new_Just(x, _ctx); /*maybe<1486>*/
      _x_x45 = kk_std_core_types__maybe_box(_x_x46, _ctx); /*102*/
...
static kk_box_t kk_std_core_maybe_show_fun53(kk_function_t _fself, kk_box_t _b_x23, kk_context_t* _ctx) {
  kk_unused(_fself);
  kk_string_t _y_x10106_25 = kk_string_unbox(_b_x23); /*string*/;
  kk_string_t _x_x54;
  kk_string_t _x_x55;
  ...
  _x_x57 = kk_std_core_types__lp__plus__plus__rp_(_y_x10106_25, _x_x58, _ctx); /*string*/
...
kk_string_t kk_std_core_maybe_show(kk_std_core_types__maybe mb, kk_function_t _implicit_fs_show, kk_context_t* _ctx) { /* forall<a,e> (mb : maybe<a>, ?show : (a) -> e string) -> e string */ 
  if (kk_std_core_types__is_Just(mb, _ctx)) {
    ...
    kk_string_t x_0_10114 = kk_function_call(kk_string_t, (kk_function_t, kk_box_t, kk_context_t*), _implicit_fs_show, (_implicit_fs_show, x, _ctx), _ctx); /*string*/;
    if (kk_yielding(kk_context())) {
      kk_string_drop(x_0_10114, _ctx);
      kk_box_t _x_x52 = kk_std_core_hnd_yield_extend(kk_std_core_maybe_new_show_fun53(_ctx), _ctx); /*2978*/
    ...
    }
    {
      ...
      _x_x62 = kk_std_core_types__lp__plus__plus__rp_(x_0_10114, _x_x63, _ctx); /*string*/
