...
kk_std_core_types__tuple2 kk_std_core_string_order2(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> (string, string) */ 
  ...
  _match_x17 = kk_std_core_order__lp__lt__rp_(_x_x23, kk_std_core_types__new_Gt(_ctx), _ctx); /*bool*/
  if (_match_x17) {
...
kk_std_core_types__maybe kk_std_core_string_maybe(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> maybe<string> */ 
  bool _match_x15;
  kk_string_t _x_x36 = kk_string_dup(s, _ctx); /*string*/
  kk_string_t _x_x37 = kk_string_empty(); /*string*/
  _match_x15 = kk_string_is_eq(_x_x36,_x_x37,kk_context()); /*bool*/
  if (_match_x15) {
...
kk_string_t kk_std_core_string_pad_left(kk_string_t s, kk_integer_t width, kk_std_core_types__optional fill, kk_context_t* _ctx) { /* (s : string, width : int, fill : ? char) -> string */ 
  kk_integer_t n;
  kk_string_t _x_x39 = kk_string_dup(s, _ctx); /*string*/
  n = kk_std_core_string_count(_x_x39, _ctx); /*int*/
  ...
  }
  {
    ...
    if (kk_std_core_types__is_Optional(fill, _ctx)) {
      ...
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x40 = _uniq_fill_334; /*char*/
    }
    else {
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x40 = ' '; /*char*/
    }
    s_0_10005 = kk_std_core_string_char_fs_string(_x_x40, _ctx); /*string*/
    kk_integer_t n_0_10006;
    kk_integer_t _x_x41 = kk_integer_dup(width, _ctx); /*int*/
    n_0_10006 = kk_integer_sub(_x_x41,n,kk_context()); /*int*/
    kk_string_t _x_x42 = kk_std_core_string_repeatz(s_0_10005, kk_std_core_int_ssize__t(n_0_10006, _ctx), _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(_x_x42, s, _ctx);
  }
}
...
kk_string_t kk_std_core_string_pad_right(kk_string_t s, kk_integer_t width, kk_std_core_types__optional fill, kk_context_t* _ctx) { /* (s : string, width : int, fill : ? char) -> string */ 
  kk_integer_t n;
  kk_string_t _x_x43 = kk_string_dup(s, _ctx); /*string*/
  n = kk_std_core_string_count(_x_x43, _ctx); /*int*/
  ...
  {
    kk_string_t s_0_10009;
    kk_char_t _x_x44;
    if (kk_std_core_types__is_Optional(fill, _ctx)) {
      kk_box_t _box_x12 = fill._cons._Optional.value;
      kk_char_t _uniq_fill_380 = kk_char_unbox(_box_x12, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x44 = _uniq_fill_380; /*char*/
    }
    else {
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x44 = ' '; /*char*/
    }
    s_0_10009 = kk_std_core_string_char_fs_string(_x_x44, _ctx); /*string*/
    kk_integer_t n_0_10010;
    kk_integer_t _x_x45 = kk_integer_dup(width, _ctx); /*int*/
    n_0_10010 = kk_integer_sub(_x_x45,n,kk_context()); /*int*/
    kk_string_t _x_x46 = kk_std_core_string_repeatz(s_0_10009, kk_std_core_int_ssize__t(n_0_10010, _ctx), _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(s, _x_x46, _ctx);
  }
}
