...
struct kk_std_core_const_fun74__t {
...
static inline kk_function_t kk_std_core_new_const_fun74(kk_box_t kkloc_default, kk_context_t* _ctx) {
  struct kk_std_core_const_fun74__t* _self = kk_function_alloc_as(struct kk_std_core_const_fun74__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_const_fun74, kk_context());
...
static inline kk_function_t kk_std_core_const(kk_box_t kkloc_default, kk_context_t* _ctx) { /* forall<a,b> (default : a) -> ((x : b) -> a) */ 
  return kk_std_core_new_const_fun74(kkloc_default, _ctx);
}
...
static inline bool kk_std_core_cmp_fs__lp__eq__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _match_x61 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/;
  if (kk_std_core_types__is_Eq(_match_x61, _ctx)) {
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core__lp__gt__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _x_x87 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x87, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline kk_box_t kk_std_core_fold(kk_integer_t upto, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (upto : int, init : a, f : (int, a) -> e a) -> e a */ 
  kk_integer_t _x_x93 = kk_integer_add_small_const(upto, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold(kk_integer_from_small(0), _x_x93, init, f, _ctx);
}
...
static inline kk_box_t kk_std_core_fold_while(kk_integer_t n, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int, init : a, f : (int, a) -> e maybe<a>) -> e a */ 
  kk_integer_t _x_x101 = kk_integer_add_small_const(n, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold_while(kk_integer_from_small(0), _x_x101, init, f, _ctx);
}
...
static inline bool kk_std_core__lp__lt__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _x_x102 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x102, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_core__lp__gt__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _x_x103 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, y, x, _ctx), _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x103, kk_std_core_types__new_Lt(_ctx), _ctx);
}
...
static inline bool kk_std_core__lp__lt__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _x_x104 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, y, x, _ctx), _ctx); /*order*/
  return kk_std_core_order__lp__eq__eq__rp_(_x_x104, kk_std_core_types__new_Gt(_ctx), _ctx);
}
...
static inline kk_unit_t kk_std_core_range_fs_for(kk_integer_t start, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : int, end : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t _x_x110 = kk_integer_dup(start, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1256(action, end, _x_x110, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_for(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t end_10011;
  kk_integer_t _x_x111 = kk_integer_dup(n, _ctx); /*int*/
  end_10011 = kk_integer_add_small_const(_x_x111, -1, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1256(action, end_10011, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
// lift anonymous function
struct kk_std_core_repeat_fun113__t {
  struct kk_function_s _base;
  kk_function_t action;
};
extern kk_unit_t kk_std_core_repeat_fun113(kk_function_t _fself, kk_integer_t i_0, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_new_repeat_fun113(kk_function_t action, kk_context_t* _ctx) {
  struct kk_std_core_repeat_fun113__t* _self = kk_function_alloc_as(struct kk_std_core_repeat_fun113__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_repeat_fun113, kk_context());
  _self->action = action;
  return kk_datatype_from_base(&_self->_base, kk_context());
}
...
static inline kk_unit_t kk_std_core_repeat(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : () -> e ()) -> e () */ 
  kk_integer_t end_10016;
  kk_integer_t _x_x112 = kk_integer_dup(n, _ctx); /*int*/
  end_10016 = kk_integer_add_small_const(_x_x112, -1, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1256(kk_std_core_new_repeat_fun113(action, _ctx), end_10016, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__maybe kk_std_core_for_while(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (n : int, action : (int) -> e maybe<a>) -> e maybe<a> */ 
  kk_integer_t end_10020 = kk_integer_add_small_const(n, -1, _ctx); /*int*/;
  return kk_std_core_range_fs__lift_for_while_1257(action, end_10020, kk_integer_from_small(0), _ctx);
}
