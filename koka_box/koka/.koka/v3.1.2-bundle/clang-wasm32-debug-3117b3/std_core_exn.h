...
static inline kk_box_t kk_std_core_exn_throw_exn(kk_std_core_exn__exception exn_0, kk_context_t* _ctx) { /* forall<a> (exn : exception) -> exn a */ 
  ...
  {
    struct kk_std_core_hnd_Ev* _con_x108 = kk_std_core_hnd__as_Ev(ev_10030, _ctx);
    ...
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      ...
      }
      {
        ...
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x14, (_fun_unbox_x14, m, ev_10030, kk_std_core_exn__exception_box(exn_0, _ctx), _ctx), _ctx);
      }
    }
  }
}
...
static inline kk_std_core_exn__error kk_std_core_exn__mlift_try_10028(kk_box_t _y_x10020, kk_context_t* _ctx) { /* forall<a,e> (a) -> <exn|e> error<a> */ 
