...
// Koka generated module: std/core/sslice, koka version: 3.1.2, platform: 32-bit
#include <kklib.h>
...
static inline kk_std_core_sslice__sslice kk_std_core_sslice_slice(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> sslice */ 
  ...
  kk_integer_t _x_x201 = kk_string_len_int(s,kk_context()); /*int*/
  return kk_std_core_sslice__new_Sslice(_x_x200, kk_integer_from_small(0), _x_x201, _ctx);
}
...
static inline kk_std_core_types__maybe kk_std_core_sslice_string_fs_foreach_while(kk_string_t s, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (s : string, action : (c : char) -> e maybe<a>) -> e maybe<a> */ 
  kk_std_core_sslice__sslice _x_x206;
  kk_string_t _x_x207 = kk_string_dup(s, _ctx); /*string*/
  kk_integer_t _x_x208 = kk_string_len_int(s,kk_context()); /*int*/
  _x_x206 = kk_std_core_sslice__new_Sslice(_x_x207, kk_integer_from_small(0), _x_x208, _ctx); /*sslice/sslice*/
  return kk_std_core_sslice_foreach_while(_x_x206, action, _ctx);
}
...
static inline kk_unit_t kk_std_core_sslice_pred_fs__mlift_count_10120(kk_ref_t cnt, kk_integer_t _y_x10103, kk_context_t* _ctx) { /* forall<h,e> (cnt : local-var<h,int>, int) -> <local<h>|e> () */ 
  kk_integer_t _b_x31_33 = kk_integer_add_small_const(_y_x10103, 1, _ctx); /*int*/;
  kk_unit_t _brw_x175 = kk_Unit;
  kk_ref_set_borrow(cnt,(kk_integer_box(_b_x31_33, _ctx)),kk_context());
  kk_ref_drop(cnt, _ctx);
  _brw_x175; return kk_Unit;
}
...
static inline bool kk_std_core_sslice_is_valid(kk_std_core_sslice__sslice slice_0, kk_context_t* _ctx) { /* (slice : sslice) -> bool */ 
  ...
  bool _brw_x140 = kk_integer_gte_borrow(_brw_x139,(kk_integer_from_small(0)),kk_context()); /*bool*/;
...
static inline bool kk_std_core_sslice_is_notempty(kk_std_core_sslice__sslice slice_0, kk_context_t* _ctx) { /* (slice : sslice) -> bool */ 
  ...
  bool _brw_x138 = kk_integer_gt_borrow(_brw_x137,(kk_integer_from_small(0)),kk_context()); /*bool*/;
...
static inline kk_std_core_sslice__sslice kk_std_core_sslice_truncate(kk_std_core_sslice__sslice slice_0, kk_context_t* _ctx) { /* (slice : sslice) -> sslice */ 
  ...
  return kk_std_core_sslice__new_Sslice(_x_x278, _x_x279, kk_integer_from_small(0), _ctx);
}
