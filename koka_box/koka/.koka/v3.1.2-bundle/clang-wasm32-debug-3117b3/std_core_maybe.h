...
static inline kk_std_core_types__maybe kk_std_core_maybe__mlift_map_10008(kk_box_t _y_x10004, kk_context_t* _ctx) { /* forall<a,e> (a) -> e maybe<a> */ 
  return kk_std_core_types__new_Just(_y_x10004, _ctx);
}
