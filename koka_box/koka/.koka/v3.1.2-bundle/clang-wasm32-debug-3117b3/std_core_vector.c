...
kk_unit_t kk_std_core_vector__mlift_lift_forz_868_10045(kk_function_t action, kk_ssize_t i, kk_ssize_t n, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<e> (action : (ssize_t) -> e (), i : ssize_t, n : ssize_t, wild_ : ()) -> e () */ 
...
struct kk_std_core_vector__lift_forz_868_fun59__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  kk_ssize_t i_0;
  kk_ssize_t n_0;
};
static kk_box_t kk_std_core_vector__lift_forz_868_fun59(kk_function_t _fself, kk_box_t _b_x3, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_forz_868_fun59(kk_function_t action_0, kk_ssize_t i_0, kk_ssize_t n_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_forz_868_fun59__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_forz_868_fun59__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_forz_868_fun59, kk_context());
...
static kk_box_t kk_std_core_vector__lift_forz_868_fun59(kk_function_t _fself, kk_box_t _b_x3, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_forz_868_fun59__t* _self = kk_function_as(struct kk_std_core_vector__lift_forz_868_fun59__t*, _fself, _ctx);
  ...
  kk_std_core_vector__mlift_lift_forz_868_10045(action_0, i_0, n_0, wild___0_5, _ctx);
...
static kk_unit_t kk_std_core_vector_vector_init_fun63(kk_function_t _fself, kk_ssize_t i_0, kk_context_t* _ctx) {
  ...
  kk_function_t f = _self->f; /* (int) -> 513 512 */
  kk_vector_t v = _self->v; /* vector<512> */
...
static kk_unit_t kk_std_core_vector_foreach_indexedz_fun70(kk_function_t _fself, kk_ssize_t i_0, kk_context_t* _ctx) {
  ...
  kk_function_t f = _self->f; /* (ssize_t, 549) -> 550 () */
  kk_vector_t v = _self->v; /* vector<549> */
  kk_drop_match(_self, {kk_function_dup(f, _ctx);kk_vector_dup(v, _ctx);}, {}, _ctx)
  kk_box_t _x_x71;
...
kk_unit_t kk_std_core_vector_foreach_indexedz(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (v : vector<a>, f : (ssize_t, a) -> e ()) -> e () */ 
  ...
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
  kk_std_core_vector__lift_forz_868(kk_std_core_vector_new_foreach_indexedz_fun70(f, v, _ctx), n_10003, i, _ctx); return kk_Unit;
}
...
static kk_unit_t kk_std_core_vector_foreach_fun72(kk_function_t _fself, kk_ssize_t i_0, kk_context_t* _ctx) {
  ...
  kk_function_t f = _self->f; /* (575) -> 576 () */
  kk_vector_t v = _self->v; /* vector<575> */
  kk_drop_match(_self, {kk_function_dup(f, _ctx);kk_vector_dup(v, _ctx);}, {}, _ctx)
  kk_box_t x_10015;
  kk_box_t _brw_x34 = kk_vector_at_borrow(v,i_0,kk_context()); /*3*/;
  kk_vector_drop(v, _ctx);
  x_10015 = _brw_x34; /*575*/
...
kk_unit_t kk_std_core_vector_foreach(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (v : vector<a>, f : (a) -> e ()) -> e () */ 
  kk_ssize_t n_10003 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/;
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
  kk_std_core_vector__lift_forz_868(kk_std_core_vector_new_foreach_fun72(f, v, _ctx), n_10003, i, _ctx); return kk_Unit;
}
...
static kk_unit_t kk_std_core_vector_foreach_indexed_fun73(kk_function_t _fself, kk_ssize_t i_0, kk_context_t* _ctx) {
  ...
  kk_function_t f = _self->f; /* (int, 605) -> 606 () */
  kk_vector_t v = _self->v; /* vector<605> */
  kk_drop_match(_self, {kk_function_dup(f, _ctx);kk_vector_dup(v, _ctx);}, {}, _ctx)
  kk_box_t x_10017;
  kk_box_t _brw_x33 = kk_vector_at_borrow(v,i_0,kk_context()); /*3*/;
  kk_vector_drop(v, _ctx);
  x_10017 = _brw_x33; /*605*/
...
kk_unit_t kk_std_core_vector_foreach_indexed(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (v : vector<a>, f : (int, a) -> e ()) -> e () */ 
  kk_ssize_t n_10003 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/;
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
  kk_std_core_vector__lift_forz_868(kk_std_core_vector_new_foreach_indexed_fun73(f, v, _ctx), n_10003, i, _ctx); return kk_Unit;
}
 
// monadic lift

kk_std_core_types__maybe kk_std_core_vector__mlift_lift_for_whilez_869_10048(kk_function_t action, kk_ssize_t i, kk_ssize_t n, kk_std_core_types__maybe _y_x10035, kk_context_t* _ctx) { /* forall<a,e> (action : (ssize_t) -> e maybe<a>, i : ssize_t, n : ssize_t, maybe<a>) -> e maybe<a> */ 
...
// lift anonymous function
struct kk_std_core_vector__lift_for_whilez_869_fun77__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  kk_ssize_t i_0;
  kk_ssize_t n_0;
};
static kk_box_t kk_std_core_vector__lift_for_whilez_869_fun77(kk_function_t _fself, kk_box_t _b_x15, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_for_whilez_869_fun77(kk_function_t action_0, kk_ssize_t i_0, kk_ssize_t n_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_for_whilez_869_fun77__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_for_whilez_869_fun77__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_for_whilez_869_fun77, kk_context());
  _self->action_0 = action_0;
  _self->i_0 = i_0;
  _self->n_0 = n_0;
  return kk_datatype_from_base(&_self->_base, kk_context());
...
static kk_box_t kk_std_core_vector__lift_for_whilez_869_fun77(kk_function_t _fself, kk_box_t _b_x15, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_for_whilez_869_fun77__t* _self = kk_function_as(struct kk_std_core_vector__lift_for_whilez_869_fun77__t*, _fself, _ctx);
  kk_function_t action_0 = _self->action_0; /* (ssize_t) -> 665 maybe<664> */
  kk_ssize_t i_0 = _self->i_0; /* ssize_t */
  kk_ssize_t n_0 = _self->n_0; /* ssize_t */
  kk_drop_match(_self, {kk_function_dup(action_0, _ctx);kk_skip_dup(i_0, _ctx);kk_skip_dup(n_0, _ctx);}, {}, _ctx)
  kk_std_core_types__maybe _y_x10035_0_17 = kk_std_core_types__maybe_unbox(_b_x15, KK_OWNED, _ctx); /*maybe<664>*/;
  kk_std_core_types__maybe _x_x78 = kk_std_core_vector__mlift_lift_for_whilez_869_10048(action_0, i_0, n_0, _y_x10035_0_17, _ctx); /*maybe<664>*/
...
kk_std_core_types__maybe kk_std_core_vector__lift_for_whilez_869(kk_function_t action_0, kk_ssize_t n_0, kk_ssize_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (ssize_t) -> e maybe<a>, n : ssize_t, i : ssize_t) -> e maybe<a> */ 
  ...
  if (_match_x31) {
    ...
    kk_function_t _x_x75 = kk_function_dup(action_0, _ctx); /*(ssize_t) -> 665 maybe<664>*/
...
static kk_std_core_types__maybe kk_std_core_vector_foreach_while_fun79(kk_function_t _fself, kk_ssize_t i_0, kk_context_t* _ctx) {
  ...
  kk_function_t f = _self->f; /* (706) -> 708 maybe<707> */
  kk_vector_t v = _self->v; /* vector<706> */
  kk_drop_match(_self, {kk_function_dup(f, _ctx);kk_vector_dup(v, _ctx);}, {}, _ctx)
  kk_box_t _x_x80;
...
kk_std_core_types__maybe kk_std_core_vector_foreach_while(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (v : vector<a>, f : (a) -> e maybe<b>) -> e maybe<b> */ 
  ...
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
  return kk_std_core_vector__lift_for_whilez_869(kk_std_core_vector_new_foreach_while_fun79(f, v, _ctx), n_10006, i, _ctx);
}
...
static kk_unit_t kk_std_core_vector_map_fun85(kk_function_t _fself, kk_ssize_t i_0, kk_context_t* _ctx) {
  ...
  kk_function_t f = _self->f; /* (764) -> 766 765 */
  kk_vector_t v = _self->v; /* vector<764> */
  kk_vector_t w = _self->w; /* vector<765> */
...
kk_vector_t kk_std_core_vector_map(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (v : vector<a>, f : (a) -> e b) -> e vector<b> */ 
  ...
  w = kk_vector_alloc(_x_x81,kk_box_null(),kk_context()); /*vector<765>*/
  kk_ssize_t n_10003 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/;
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
...
kk_std_core_types__list kk_std_core_vector_vlist(kk_vector_t v, kk_std_core_types__optional tail, kk_context_t* _ctx) { /* forall<a> (v : vector<a>, tail : ? (list<a>)) -> list<a> */ 
  ...
  if (kk_std_core_types__is_Optional(tail, _ctx)) {
    ...
    kk_std_core_types__list _uniq_tail_782 = kk_std_core_types__list_unbox(_box_x26, KK_BORROWED, _ctx);
    kk_std_core_types__list_dup(_uniq_tail_782, _ctx);
    kk_std_core_types__optional_drop(tail, _ctx);
    _x_x91 = _uniq_tail_782; /*list<795>*/
  }
  else {
    kk_std_core_types__optional_drop(tail, _ctx);
    _x_x91 = kk_std_core_types__new_Nil(_ctx); /*list<795>*/
  }
