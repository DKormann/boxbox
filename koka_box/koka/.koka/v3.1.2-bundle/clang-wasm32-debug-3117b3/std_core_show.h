...
static inline kk_string_t kk_std_core_show_char_fs_show(kk_char_t c, kk_context_t* _ctx) { /* (c : char) -> string */ 
  ...
  kk_string_t _x_x120;
  kk_string_t _x_x121 = kk_std_core_show_show_char(c, _ctx); /*string*/
  kk_string_t _x_x122;
  kk_define_string_literal(, _s_x123, 1, "\'", _ctx)
  _x_x122 = kk_string_dup(_s_x123, _ctx); /*string*/
  _x_x120 = kk_std_core_types__lp__plus__plus__rp_(_x_x121, _x_x122, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x118, _x_x120, _ctx);
}
...
static inline kk_string_t kk_std_core_show_sslice_fs_show(kk_std_core_sslice__sslice s, kk_context_t* _ctx) { /* (s : sslice/sslice) -> string */ 
  kk_string_t _x_x136 = kk_std_core_sslice_string(s, _ctx); /*string*/
  return kk_std_core_show_string_fs_show(_x_x136, _ctx);
}
