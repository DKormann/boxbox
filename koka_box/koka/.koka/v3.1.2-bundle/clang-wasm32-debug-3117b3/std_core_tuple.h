...
// Koka generated module: std/core/tuple, koka version: 3.1.2, platform: 32-bit
#include <kklib.h>
...
static inline kk_string_t kk_std_core_tuple_tuple2_fs__mlift_show_10038(kk_string_t _y_x10009, kk_string_t _y_x10010, kk_context_t* _ctx) { /* forall<e> (string, string) -> e string */ 
  ...
  _x_x208 = kk_std_core_types__lp__plus__plus__rp_(_y_x10010, _x_x209, _ctx); /*string*/
  _x_x205 = kk_std_core_types__lp__plus__plus__rp_(_x_x206, _x_x208, _ctx); /*string*/
  _x_x204 = kk_std_core_types__lp__plus__plus__rp_(_y_x10009, _x_x205, _ctx); /*string*/
