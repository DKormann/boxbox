...
// monadic lift
export function _mlift_force_10110(r, x_0) /* forall<a,e> (r : ref<global,either<() -> e a,a>>, x@0 : a) -> <st<global>,div|e> a */  {
...
export function force(delayed) /* forall<a,e> (delayed : delayed<e,a>) -> e a */  {
  ...
  if (_x1._tag === 2) {
    ...
    var x_0_10111 = _x1.left();
     
    var next_10112 = function(x_0_0 /* 270 */ ) {
    ...
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(next_10112);
    }
    else {
      return next_10112(x_0_10111);
    }
  }
}
