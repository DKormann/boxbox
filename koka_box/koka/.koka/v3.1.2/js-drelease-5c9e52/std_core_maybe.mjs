...
// monadic lift
export function _mlift_map_10108(_y_x10104) /* forall<a,e> (a) -> e maybe<a> */  {
  return $std_core_types.Just(_y_x10104);
}
...
export function map(m, f) /* forall<a,b,e> (m : maybe<a>, f : (a) -> e b) -> e maybe<b> */  {
  if (m === null) {
    ...
    var x_0_10110 = f(m.value);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10104 /* 183 */ ) {
        return $std_core_types.Just(_y_x10104);
      });
    }
    else {
      return $std_core_types.Just(x_0_10110);
    }
  }
}
...
// monadic lift
export function _mlift_show_10109(_y_x10106) /* forall<e> (string) -> e string */  {
  return $std_core_types._lp__plus__plus__rp_("Just(", $std_core_types._lp__plus__plus__rp_(_y_x10106, ")"));
}
...
export function show(mb, _implicit_fs_show) /* forall<a,e> (mb : maybe<a>, ?show : (a) -> e string) -> e string */  {
  if (mb !== null) {
    ...
    var x_0_10114 = _implicit_fs_show(mb.value);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10106 /* string */ ) {
        return $std_core_types._lp__plus__plus__rp_("Just(", $std_core_types._lp__plus__plus__rp_(_y_x10106, ")"));
      });
    }
    else {
      return $std_core_types._lp__plus__plus__rp_("Just(", $std_core_types._lp__plus__plus__rp_(x_0_10114, ")"));
    }
  }
  else {
    return "Nothing";
