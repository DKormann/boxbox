// Koka generated module: std/core/delayed, koka version: 3.1.2, platform: 32-bit
...
kk_box_t kk_std_core_delayed_force(kk_std_core_delayed__delayed delayed, kk_context_t* _ctx) { /* forall<a,e> (delayed : delayed<e,a>) -> e a */ 
  ...
  }
  {
    ...
    x_0_10111 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), _x_x42, (_x_x42, _ctx), _ctx); /*270*/
    kk_function_t next_10112 = kk_std_core_delayed_new_force_fun43(delayed, _ctx); /*(270) -> <st<global>,div|271> 270*/;
    if (kk_yielding(kk_context())) {
      kk_box_drop(x_0_10111, _ctx);
      return kk_std_core_hnd_yield_extend(next_10112, _ctx);
    }
    {
      return kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), next_10112, (next_10112, x_0_10111, _ctx), _ctx);
    }
  }
}
