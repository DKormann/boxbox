// Koka generated module: std/core/debug, koka version: 3.1.2, platform: 32-bit
...
kk_unit_t kk_std_core_debug_trace_info(kk_string_t message, kk_string_t _implicit_fs_kk_file_line, kk_context_t* _ctx) { /* (message : string, ?kk-file-line : string) -> () */ 
  ...
  kk_string_t _x_x26;
  kk_string_t _x_x27;
  kk_define_string_literal(, _s_x28, 2, ": ", _ctx)
  _x_x27 = kk_string_dup(_s_x28, _ctx); /*string*/
  _x_x26 = kk_std_core_types__lp__plus__plus__rp_(_x_x27, message, _ctx); /*string*/
  message_0_10002 = kk_std_core_types__lp__plus__plus__rp_(_implicit_fs_kk_file_line, _x_x26, _ctx); /*string*/
  bool _match_x16;
  kk_box_t _x_x29;
...
kk_unit_t kk_std_core_debug_trace_show(kk_box_t x, kk_function_t _implicit_fs_show, kk_string_t _implicit_fs_kk_file_line, kk_context_t* _ctx) { /* forall<a> (x : a, ?show : (a) -> string, ?kk-file-line : string) -> () */ 
  kk_string_t message_10004 = kk_function_call(kk_string_t, (kk_function_t, kk_box_t, kk_context_t*), _implicit_fs_show, (_implicit_fs_show, x, _ctx), _ctx); /*string*/;
  kk_string_t message_0_10006;
  kk_string_t _x_x31;
  kk_string_t _x_x32;
  kk_define_string_literal(, _s_x33, 2, ": ", _ctx)
  _x_x32 = kk_string_dup(_s_x33, _ctx); /*string*/
  _x_x31 = kk_std_core_types__lp__plus__plus__rp_(_x_x32, message_10004, _ctx); /*string*/
  message_0_10006 = kk_std_core_types__lp__plus__plus__rp_(_implicit_fs_kk_file_line, _x_x31, _ctx); /*string*/
  bool _match_x15;
  kk_box_t _x_x34;
  ...
  if (_match_x15) {
    kk_std_core_debug_xtrace(message_0_10006, _ctx); return kk_Unit;
  }
  {
    kk_string_drop(message_0_10006, _ctx);
    kk_Unit; return kk_Unit;
  }
}
...
kk_unit_t kk_std_core_debug_assert(kk_string_t message, bool condition, kk_string_t _implicit_fs_kk_file_line, kk_context_t* _ctx) { /* (message : string, condition : bool, ?kk-file-line : string) -> () */ 
  ...
  }
  {
    ...
    kk_string_t _x_x39;
    kk_string_t _x_x40;
    kk_define_string_literal(, _s_x41, 2, ": ", _ctx)
    _x_x40 = kk_string_dup(_s_x41, _ctx); /*string*/
    _x_x39 = kk_std_core_types__lp__plus__plus__rp_(_x_x40, message, _ctx); /*string*/
    _x_x38 = kk_std_core_types__lp__plus__plus__rp_(_implicit_fs_kk_file_line, _x_x39, _ctx); /*string*/
    kk_std_core_debug_unsafe_assert_fail(_x_x38, _ctx); return kk_Unit;
  }
}
