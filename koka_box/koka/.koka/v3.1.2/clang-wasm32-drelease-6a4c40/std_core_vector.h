...
static inline kk_integer_t kk_std_core_vector_length(kk_vector_t v, kk_context_t* _ctx) { /* forall<a> (v : vector<a>) -> int */ 
  kk_ssize_t _x_x81 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/
  return kk_integer_from_ssize_t(_x_x81,kk_context());
}
...
static inline kk_vector_t kk_std_core_vector_vector(kk_integer_t n, kk_box_t kkloc_default, kk_context_t* _ctx) { /* forall<a> (n : int, default : a) -> vector<a> */ 
  kk_ssize_t _x_x82;
  kk_integer_t _x_x83 = kk_integer_dup(n, _ctx); /*int*/
  _x_x82 = kk_std_core_int_ssize__t(_x_x83, _ctx); /*ssize_t*/
  return kk_std_core_vector_vector_alloc(_x_x82, kkloc_default, _ctx);
}
...
struct kk_std_core_vector_vector_init_total_fun86__t {
  struct kk_function_s _base;
  kk_function_t f;
};
extern kk_box_t kk_std_core_vector_vector_init_total_fun86(kk_function_t _fself, kk_ssize_t i, kk_context_t* _ctx);
static inline kk_function_t kk_std_core_vector_new_vector_init_total_fun86(kk_function_t f, kk_context_t* _ctx) {
  struct kk_std_core_vector_vector_init_total_fun86__t* _self = kk_function_alloc_as(struct kk_std_core_vector_vector_init_total_fun86__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector_vector_init_total_fun86, kk_context());
  _self->f = f;
...
static inline kk_vector_t kk_std_core_vector_vector_init_total(kk_integer_t n, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int, f : (int) -> a) -> e vector<a> */ 
  kk_ssize_t _x_x84;
  kk_integer_t _x_x85 = kk_integer_dup(n, _ctx); /*int*/
  _x_x84 = kk_std_core_int_ssize__t(_x_x85, _ctx); /*ssize_t*/
  return kk_std_core_vector_vector_alloc_total(_x_x84, kk_std_core_vector_new_vector_init_total_fun86(f, _ctx), _ctx);
}
