...
static inline kk_std_core_types__maybe kk_std_core_maybe__mlift_map_10110(kk_box_t _y_x10106, kk_context_t* _ctx) { /* forall<a,e> (a) -> e maybe<a> */ 
  return kk_std_core_types__new_Just(_y_x10106, _ctx);
}
...
static inline kk_string_t kk_std_core_maybe__mlift_show_10111(kk_string_t _y_x10108, kk_context_t* _ctx) { /* forall<e> (string) -> e string */ 
  kk_string_t _x_x63;
  kk_define_string_literal(, _s_x64, 5, "Just(", _ctx)
  _x_x63 = kk_string_dup(_s_x64, _ctx); /*string*/
  kk_string_t _x_x65;
  kk_string_t _x_x66;
  kk_define_string_literal(, _s_x67, 1, ")", _ctx)
  _x_x66 = kk_string_dup(_s_x67, _ctx); /*string*/
  _x_x65 = kk_std_core_types__lp__plus__plus__rp_(_y_x10108, _x_x66, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x63, _x_x65, _ctx);
}
