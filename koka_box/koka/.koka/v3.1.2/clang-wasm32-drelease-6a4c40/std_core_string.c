// Koka generated module: std/core/string, koka version: 3.1.2, platform: 32-bit
...
kk_std_core_types__order kk_std_core_string_cmp(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> order */ 
  ...
  bool _match_x28 = kk_integer_lt_borrow(i_10000,(kk_integer_from_small(0)),kk_context()); /*bool*/;
  if (_match_x28) {
  ...
  {
    bool _match_x29;
    bool _brw_x30 = kk_integer_gt_borrow(i_10000,(kk_integer_from_small(0)),kk_context()); /*bool*/;
    kk_integer_drop(i_10000, _ctx);
    _match_x29 = _brw_x30; /*bool*/
    if (_match_x29) {
...
kk_std_core_types__tuple2 kk_std_core_string_order2(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> (string, string) */ 
  ...
  _match_x33: ;
  bool _brw_x23 = kk_integer_lt_borrow(_brw_x22,(kk_integer_from_small(1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x22, _ctx);
  _match_x21 = _brw_x23; /*bool*/
  if (_match_x21) {
...
kk_std_core_types__maybe kk_std_core_string_maybe(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> maybe<string> */ 
  bool _match_x15;
  kk_string_t _x_x46 = kk_string_dup(s, _ctx); /*string*/
  kk_string_t _x_x47 = kk_string_empty(); /*string*/
  _match_x15 = kk_string_is_eq(_x_x46,_x_x47,kk_context()); /*bool*/
  if (_match_x15) {
...
kk_string_t kk_std_core_string_pad_left(kk_string_t s, kk_integer_t width, kk_std_core_types__optional fill, kk_context_t* _ctx) { /* (s : string, width : int, fill : ? char) -> string */ 
  kk_integer_t n;
  kk_string_t _x_x49 = kk_string_dup(s, _ctx); /*string*/
  n = kk_std_core_string_count(_x_x49, _ctx); /*int*/
  ...
  {
    kk_string_t s_0_10011;
    kk_char_t _x_x50;
    if (kk_std_core_types__is_Optional(fill, _ctx)) {
      kk_box_t _box_x11 = fill._cons._Optional.value;
      kk_char_t _uniq_fill_334 = kk_char_unbox(_box_x11, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x50 = _uniq_fill_334; /*char*/
    }
    else {
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x50 = ' '; /*char*/
    }
    s_0_10011 = kk_std_core_string_char_fs_string(_x_x50, _ctx); /*string*/
    kk_integer_t n_0_10012;
    kk_integer_t _x_x51 = kk_integer_dup(width, _ctx); /*int*/
    n_0_10012 = kk_integer_sub(_x_x51,n,kk_context()); /*int*/
    kk_string_t _x_x52 = kk_std_core_string_repeatz(s_0_10011, kk_std_core_int_ssize__t(n_0_10012, _ctx), _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(_x_x52, s, _ctx);
  }
}
...
kk_string_t kk_std_core_string_pad_right(kk_string_t s, kk_integer_t width, kk_std_core_types__optional fill, kk_context_t* _ctx) { /* (s : string, width : int, fill : ? char) -> string */ 
  kk_integer_t n;
  kk_string_t _x_x53 = kk_string_dup(s, _ctx); /*string*/
  n = kk_std_core_string_count(_x_x53, _ctx); /*int*/
  bool _match_x13 = kk_integer_lte_borrow(width,n,kk_context()); /*bool*/;
  if (_match_x13) {
    kk_integer_drop(n, _ctx);
    kk_std_core_types__optional_drop(fill, _ctx);
    return s;
  ...
  {
    kk_string_t s_0_10015;
    kk_char_t _x_x54;
    if (kk_std_core_types__is_Optional(fill, _ctx)) {
      kk_box_t _box_x12 = fill._cons._Optional.value;
      kk_char_t _uniq_fill_380 = kk_char_unbox(_box_x12, KK_BORROWED, _ctx);
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x54 = _uniq_fill_380; /*char*/
    }
    else {
      kk_std_core_types__optional_drop(fill, _ctx);
      _x_x54 = ' '; /*char*/
    }
    s_0_10015 = kk_std_core_string_char_fs_string(_x_x54, _ctx); /*string*/
    kk_integer_t n_0_10016;
    kk_integer_t _x_x55 = kk_integer_dup(width, _ctx); /*int*/
    n_0_10016 = kk_integer_sub(_x_x55,n,kk_context()); /*int*/
    kk_string_t _x_x56 = kk_std_core_string_repeatz(s_0_10015, kk_std_core_int_ssize__t(n_0_10016, _ctx), _ctx); /*string*/
    return kk_std_core_types__lp__plus__plus__rp_(s, _x_x56, _ctx);
  }
}
