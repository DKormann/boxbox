...
static inline kk_box_t kk_std_core_exn_throw_exn(kk_std_core_exn__exception exn_0, kk_context_t* _ctx) { /* forall<a> (exn : exception) -> exn a */ 
  ...
  {
    struct kk_std_core_hnd_Ev* _con_x108 = kk_std_core_hnd__as_Ev(ev_10130, _ctx);
    kk_box_t _box_x10 = _con_x108->hnd;
    int32_t m = _con_x108->marker;
    kk_std_core_exn__exn h = kk_std_core_exn__exn_unbox(_box_x10, KK_BORROWED, _ctx);
    kk_std_core_exn__exn_dup(h, _ctx);
    {
      struct kk_std_core_exn__Hnd_exn* _con_x109 = kk_std_core_exn__as_Hnd_exn(h, _ctx);
      kk_integer_t _pat_0_0 = _con_x109->_cfc;
      kk_std_core_hnd__clause1 _brk_throw_exn = _con_x109->_brk_throw_exn;
      ...
      {
        kk_function_t _fun_unbox_x14 = _brk_throw_exn.clause;
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x14, (_fun_unbox_x14, m, ev_10130, kk_std_core_exn__exception_box(exn_0, _ctx), _ctx), _ctx);
      }
    }
  }
}
...
static inline kk_std_core_exn__error kk_std_core_exn__mlift_try_10128(kk_box_t _y_x10120, kk_context_t* _ctx) { /* forall<a,e> (a) -> <exn|e> error<a> */ 
  return kk_std_core_exn__new_Ok(_y_x10120, _ctx);
}
...
static inline kk_box_t kk_std_core_exn_on_exit(kk_function_t hndler, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (hndler : () -> e (), action : () -> e a) -> e a */ 
  kk_box_t _x_x160 = kk_function_call(kk_box_t, (kk_function_t, kk_context_t*), action, (action, _ctx), _ctx); /*860*/
  return kk_std_core_hnd_finally_prompt(hndler, _x_x160, _ctx);
}
