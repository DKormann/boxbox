...
kk_box_t kk_std_core_vector__index(kk_vector_t v, kk_integer_t index, kk_context_t* _ctx) { /* forall<a> (v : vector<a>, index : int) -> exn a */ 
  kk_ssize_t idx;
  kk_integer_t _x_x71 = kk_integer_dup(index, _ctx); /*int*/
  idx = kk_std_core_int_ssize__t(_x_x71, _ctx); /*ssize_t*/
  bool _match_x68;
  kk_ssize_t _x_x72 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/
  _match_x68 = (idx < _x_x72); /*bool*/
  if (_match_x68) {
  ...
  }
  {
    ...
    {
      struct kk_std_core_hnd_Ev* _con_x73 = kk_std_core_hnd__as_Ev(ev_10262, _ctx);
      kk_box_t _box_x0 = _con_x73->hnd;
      ...
      kk_std_core_hnd__clause1 _brw_x70 = kk_std_core_exn__select_throw_exn(h, _ctx); /*hnd/clause1<exception,403,exn,404,405>*/;
      kk_std_core_exn__exn_drop(h, _ctx);
      _match_x69 = _brw_x70; /*hnd/clause1<exception,403,exn,404,405>*/
      {
        kk_function_t _fun_unbox_x4 = _match_x69.clause;
        kk_box_t _x_x74;
        kk_std_core_exn__exception _x_x75;
        kk_string_t _x_x76;
        kk_define_string_literal(, _s_x77, 19, "index out of bounds", _ctx)
        _x_x76 = kk_string_dup(_s_x77, _ctx); /*string*/
        _x_x75 = kk_std_core_exn__new_Exception(_x_x76, kk_std_core_exn__new_ExnRange(_ctx), _ctx); /*exception*/
        _x_x74 = kk_std_core_exn__exception_box(_x_x75, _ctx); /*45*/
        return kk_function_call(kk_box_t, (kk_function_t, int32_t, kk_std_core_hnd__ev, kk_box_t, kk_context_t*), _fun_unbox_x4, (_fun_unbox_x4, m, ev_10262, _x_x74, _ctx), _ctx);
      }
    }
  }
}
...
kk_std_core_types__maybe kk_std_core_vector_at(kk_vector_t v, kk_integer_t index, kk_context_t* _ctx) { /* forall<a> (v : vector<a>, index : int) -> maybe<a> */ 
  kk_ssize_t idx;
  kk_integer_t _x_x78 = kk_integer_dup(index, _ctx); /*int*/
  idx = kk_std_core_int_ssize__t(_x_x78, _ctx); /*ssize_t*/
  bool _match_x67;
  kk_ssize_t _x_x79 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/
  _match_x67 = (idx < _x_x79); /*bool*/
  if (_match_x67) {
    kk_box_t _x_x80 = kk_vector_at_borrow(v,idx,kk_context()); /*3*/
    return kk_std_core_types__new_Just(_x_x80, _ctx);
  }
  {
    return kk_std_core_types__new_Nothing(_ctx);
  }
}
extern kk_box_t kk_std_core_vector_vector_init_total_fun86(kk_function_t _fself, kk_ssize_t i, kk_context_t* _ctx) {
  struct kk_std_core_vector_vector_init_total_fun86__t* _self = kk_function_as(struct kk_std_core_vector_vector_init_total_fun86__t*, _fself, _ctx);
  kk_function_t f = _self->f; /* (int) -> 422 */
  kk_drop_match(_self, {kk_function_dup(f, _ctx);}, {}, _ctx)
  kk_integer_t _x_x87 = kk_integer_from_ssize_t(i,kk_context()); /*int*/
  return kk_function_call(kk_box_t, (kk_function_t, kk_integer_t, kk_context_t*), f, (f, _x_x87, _ctx), _ctx);
}
...
kk_unit_t kk_std_core_vector__mlift_lift_forz_868_10252(kk_function_t action, kk_ssize_t i, kk_ssize_t n, kk_unit_t wild__, kk_context_t* _ctx) { /* forall<e> (action : (ssize_t) -> e (), i : ssize_t, n : ssize_t, wild_ : ()) -> e () */ 
  kk_ssize_t i_0_10002 = kk_std_core_vector_ssize__t_fs_incr(i, _ctx); /*ssize_t*/;
  kk_std_core_vector__lift_forz_868(action, n, i_0_10002, _ctx); return kk_Unit;
}
...
struct kk_std_core_vector__lift_forz_868_fun90__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  kk_ssize_t i_0;
  kk_ssize_t n_0;
};
static kk_box_t kk_std_core_vector__lift_forz_868_fun90(kk_function_t _fself, kk_box_t _b_x9, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_forz_868_fun90(kk_function_t action_0, kk_ssize_t i_0, kk_ssize_t n_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_forz_868_fun90__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_forz_868_fun90__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_forz_868_fun90, kk_context());
...
static kk_box_t kk_std_core_vector__lift_forz_868_fun90(kk_function_t _fself, kk_box_t _b_x9, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_forz_868_fun90__t* _self = kk_function_as(struct kk_std_core_vector__lift_forz_868_fun90__t*, _fself, _ctx);
  ...
  kk_unit_unbox(_b_x9);
  kk_unit_t _x_x91 = kk_Unit;
  kk_std_core_vector__mlift_lift_forz_868_10252(action_0, i_0, n_0, wild___0_11, _ctx);
  return kk_unit_box(_x_x91);
}
...
kk_unit_t kk_std_core_vector__lift_forz_868(kk_function_t action_0, kk_ssize_t n_0, kk_ssize_t i_0, kk_context_t* _ctx) { /* forall<e> (action : (ssize_t) -> e (), n : ssize_t, i : ssize_t) -> e () */ 
  ...
  if (_match_x65) {
    ...
    kk_function_t _x_x88 = kk_function_dup(action_0, _ctx); /*(ssize_t) -> 470 ()*/
    kk_function_call(kk_unit_t, (kk_function_t, kk_ssize_t, kk_context_t*), _x_x88, (_x_x88, i_0, _ctx), _ctx);
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x89 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_forz_868_fun90(action_0, i_0, n_0, _ctx), _ctx); /*2978*/
      kk_unit_unbox(_x_x89); return kk_Unit;
    }
    {
...
kk_unit_t kk_std_core_vector__mlift_lift_vector_init_10184_10253(kk_ssize_t _uniq_i_10130, kk_ssize_t _uniq_n_10129, kk_function_t f, kk_vector_t v, kk_box_t _y_x10221, kk_context_t* _ctx) { /* forall<a,e> (ssize_t, ssize_t, f : (int) -> e a, v : vector<a>, a) -> e () */ 
  ...
  kk_vector_t _x_x92 = kk_vector_dup(v, _ctx); /*vector<512>*/
  kk_vector_unsafe_assign(_x_x92,_uniq_i_10130,_y_x10221,kk_context());
...
// specialized: std/core/vector/@lift-forz@868, on parameters @uniq-action@10128, using:
...
// lift anonymous function
struct kk_std_core_vector__lift_vector_init_10184_fun96__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  kk_vector_t v_0;
...
static kk_box_t kk_std_core_vector__lift_vector_init_10184_fun96(kk_function_t _fself, kk_box_t _b_x13, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_vector_init_10184_fun96(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_i_10130_0, kk_ssize_t _uniq_n_10129_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_vector_init_10184_fun96__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_vector_init_10184_fun96__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_vector_init_10184_fun96, kk_context());
  _self->f_0 = f_0;
  _self->v_0 = v_0;
...
static kk_box_t kk_std_core_vector__lift_vector_init_10184_fun96(kk_function_t _fself, kk_box_t _b_x13, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_vector_init_10184_fun96__t* _self = kk_function_as(struct kk_std_core_vector__lift_vector_init_10184_fun96__t*, _fself, _ctx);
  ...
  kk_box_t _y_x10221_0_15 = _b_x13; /*512*/;
...
kk_unit_t kk_std_core_vector__lift_vector_init_10184(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_n_10129_0, kk_ssize_t _uniq_i_10130_0, kk_context_t* _ctx) { /* forall<a,e> (f : (int) -> e a, v : vector<a>, ssize_t, ssize_t) -> e () */ 
  ...
  if (_match_x63) {
    kk_box_t x_10268;
    kk_function_t _x_x94 = kk_function_dup(f_0, _ctx); /*(int) -> 513 512*/
    kk_integer_t _x_x93 = kk_integer_from_ssize_t(_uniq_i_10130_0,kk_context()); /*int*/
    x_10268 = kk_function_call(kk_box_t, (kk_function_t, kk_integer_t, kk_context_t*), _x_x94, (_x_x94, _x_x93, _ctx), _ctx); /*512*/
    if (kk_yielding(kk_context())) {
      kk_box_drop(x_10268, _ctx);
      kk_box_t _x_x95 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_vector_init_10184_fun96(f_0, v_0, _uniq_i_10130_0, _uniq_n_10129_0, _ctx), _ctx); /*2978*/
      kk_unit_unbox(_x_x95); return kk_Unit;
    }
    {
      kk_unit_t _uniq_x___10132_0 = kk_Unit;
      kk_vector_t _x_x98 = kk_vector_dup(v_0, _ctx); /*vector<512>*/
      kk_vector_unsafe_assign(_x_x98,_uniq_i_10130_0,x_10268,kk_context());
...
// lift anonymous function
struct kk_std_core_vector_vector_init_fun102__t {
  struct kk_function_s _base;
  kk_vector_t v;
};
static kk_box_t kk_std_core_vector_vector_init_fun102(kk_function_t _fself, kk_box_t _b_x17, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector_new_vector_init_fun102(kk_vector_t v, kk_context_t* _ctx) {
  struct kk_std_core_vector_vector_init_fun102__t* _self = kk_function_alloc_as(struct kk_std_core_vector_vector_init_fun102__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector_vector_init_fun102, kk_context());
  _self->v = v;
  return kk_datatype_from_base(&_self->_base, kk_context());
}

static kk_box_t kk_std_core_vector_vector_init_fun102(kk_function_t _fself, kk_box_t _b_x17, kk_context_t* _ctx) {
  struct kk_std_core_vector_vector_init_fun102__t* _self = kk_function_as(struct kk_std_core_vector_vector_init_fun102__t*, _fself, _ctx);
...
kk_vector_t kk_std_core_vector_vector_init(kk_integer_t n, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int, f : (int) -> e a) -> e vector<a> */ 
  kk_ssize_t len;
  kk_integer_t _x_x99 = kk_integer_dup(n, _ctx); /*int*/
  len = kk_std_core_int_ssize__t(_x_x99, _ctx); /*ssize_t*/
  kk_vector_t v = kk_vector_alloc(len,kk_box_null(),kk_context()); /*vector<512>*/;
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
  kk_unit_t x_10271 = kk_Unit;
  kk_vector_t _x_x100 = kk_vector_dup(v, _ctx); /*vector<512>*/
  kk_std_core_vector__lift_vector_init_10184(f, _x_x100, len, i, _ctx);
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x101 = kk_std_core_hnd_yield_extend(kk_std_core_vector_new_vector_init_fun102(v, _ctx), _ctx); /*2978*/
    return kk_vector_unbox(_x_x101, _ctx);
  }
  {
    return v;
  }
...
// specialized: std/core/vector/@lift-forz@868, on parameters @uniq-action@10137, using:
...
// lift anonymous function
struct kk_std_core_vector__lift_foreach_indexedz_10185_fun106__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  kk_vector_t v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_indexedz_10185_fun106(kk_function_t _fself, kk_box_t _b_x21, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_foreach_indexedz_10185_fun106(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_i_10139_0, kk_ssize_t _uniq_n_10138_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_indexedz_10185_fun106__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_foreach_indexedz_10185_fun106__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_foreach_indexedz_10185_fun106, kk_context());
  _self->f_0 = f_0;
  _self->v_0 = v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_indexedz_10185_fun106(kk_function_t _fself, kk_box_t _b_x21, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_indexedz_10185_fun106__t* _self = kk_function_as(struct kk_std_core_vector__lift_foreach_indexedz_10185_fun106__t*, _fself, _ctx);
...
kk_unit_t kk_std_core_vector__lift_foreach_indexedz_10185(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_n_10138_0, kk_ssize_t _uniq_i_10139_0, kk_context_t* _ctx) { /* forall<a,e> (f : (ssize_t, a) -> e (), v : vector<a>, ssize_t, ssize_t) -> e () */ 
  ...
  if (_match_x60) {
    ...
    kk_function_t _x_x104 = kk_function_dup(f_0, _ctx); /*(ssize_t, 549) -> 550 ()*/
    kk_box_t _x_x103 = kk_vector_at_borrow(v_0,_uniq_i_10139_0,kk_context()); /*3*/
    kk_function_call(kk_unit_t, (kk_function_t, kk_ssize_t, kk_box_t, kk_context_t*), _x_x104, (_x_x104, _uniq_i_10139_0, _x_x103, _ctx), _ctx);
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x105 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_foreach_indexedz_10185_fun106(f_0, v_0, _uniq_i_10139_0, _uniq_n_10138_0, _ctx), _ctx); /*2978*/
      kk_unit_unbox(_x_x105); return kk_Unit;
    }
    {
...
// specialized: std/core/vector/@lift-forz@868, on parameters @uniq-action@10146, using:
...
// lift anonymous function
struct kk_std_core_vector__lift_foreach_10186_fun110__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  kk_vector_t v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_10186_fun110(kk_function_t _fself, kk_box_t _b_x25, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_foreach_10186_fun110(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_i_10148_0, kk_ssize_t _uniq_n_10147_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_10186_fun110__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_foreach_10186_fun110__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_foreach_10186_fun110, kk_context());
  _self->f_0 = f_0;
  _self->v_0 = v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_10186_fun110(kk_function_t _fself, kk_box_t _b_x25, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_10186_fun110__t* _self = kk_function_as(struct kk_std_core_vector__lift_foreach_10186_fun110__t*, _fself, _ctx);
...
kk_unit_t kk_std_core_vector__lift_foreach_10186(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_n_10147_0, kk_ssize_t _uniq_i_10148_0, kk_context_t* _ctx) { /* forall<a,e> (f : (a) -> e (), v : vector<a>, ssize_t, ssize_t) -> e () */ 
  ...
  if (_match_x58) {
    kk_box_t x_10023 = kk_vector_at_borrow(v_0,_uniq_i_10148_0,kk_context()); /*575*/;
    kk_unit_t x_10279 = kk_Unit;
    kk_function_t _x_x108 = kk_function_dup(f_0, _ctx); /*(575) -> 576 ()*/
    kk_function_call(kk_unit_t, (kk_function_t, kk_box_t, kk_context_t*), _x_x108, (_x_x108, x_10023, _ctx), _ctx);
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x109 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_foreach_10186_fun110(f_0, v_0, _uniq_i_10148_0, _uniq_n_10147_0, _ctx), _ctx); /*2978*/
...
// specialized: std/core/vector/@lift-forz@868, on parameters @uniq-action@10155, using:
...
// lift anonymous function
struct kk_std_core_vector__lift_foreach_indexed_10187_fun115__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  kk_vector_t v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_indexed_10187_fun115(kk_function_t _fself, kk_box_t _b_x29, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_foreach_indexed_10187_fun115(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_i_10157_0, kk_ssize_t _uniq_n_10156_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_indexed_10187_fun115__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_foreach_indexed_10187_fun115__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_foreach_indexed_10187_fun115, kk_context());
  _self->f_0 = f_0;
  _self->v_0 = v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_indexed_10187_fun115(kk_function_t _fself, kk_box_t _b_x29, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_indexed_10187_fun115__t* _self = kk_function_as(struct kk_std_core_vector__lift_foreach_indexed_10187_fun115__t*, _fself, _ctx);
...
kk_unit_t kk_std_core_vector__lift_foreach_indexed_10187(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_n_10156_0, kk_ssize_t _uniq_i_10157_0, kk_context_t* _ctx) { /* forall<a,e> (f : (int, a) -> e (), v : vector<a>, ssize_t, ssize_t) -> e () */ 
  ...
  if (_match_x56) {
    kk_box_t x_10025 = kk_vector_at_borrow(v_0,_uniq_i_10157_0,kk_context()); /*605*/;
    kk_unit_t x_10282 = kk_Unit;
    kk_function_t _x_x113 = kk_function_dup(f_0, _ctx); /*(int, 605) -> 606 ()*/
    kk_integer_t _x_x112 = kk_integer_from_ssize_t(_uniq_i_10157_0,kk_context()); /*int*/
    kk_function_call(kk_unit_t, (kk_function_t, kk_integer_t, kk_box_t, kk_context_t*), _x_x113, (_x_x113, _x_x112, x_10025, _ctx), _ctx);
    if (kk_yielding(kk_context())) {
      kk_box_t _x_x114 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_foreach_indexed_10187_fun115(f_0, v_0, _uniq_i_10157_0, _uniq_n_10156_0, _ctx), _ctx); /*2978*/
      kk_unit_unbox(_x_x114); return kk_Unit;
    }
    {
...
kk_std_core_types__maybe kk_std_core_vector__mlift_lift_for_whilez_869_10258(kk_function_t action, kk_ssize_t i, kk_ssize_t n, kk_std_core_types__maybe _y_x10237, kk_context_t* _ctx) { /* forall<a,e> (action : (ssize_t) -> e maybe<a>, i : ssize_t, n : ssize_t, maybe<a>) -> e maybe<a> */ 
  if (kk_std_core_types__is_Nothing(_y_x10237, _ctx)) {
    kk_ssize_t i_0_10015 = kk_std_core_vector_ssize__t_fs_incr(i, _ctx); /*ssize_t*/;
    return kk_std_core_vector__lift_for_whilez_869(action, n, i_0_10015, _ctx);
  }
  {
...
// lift anonymous function
struct kk_std_core_vector__lift_for_whilez_869_fun119__t {
  struct kk_function_s _base;
  kk_function_t action_0;
  kk_ssize_t i_0;
  kk_ssize_t n_0;
};
static kk_box_t kk_std_core_vector__lift_for_whilez_869_fun119(kk_function_t _fself, kk_box_t _b_x33, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_for_whilez_869_fun119(kk_function_t action_0, kk_ssize_t i_0, kk_ssize_t n_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_for_whilez_869_fun119__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_for_whilez_869_fun119__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_for_whilez_869_fun119, kk_context());
  _self->action_0 = action_0;
  _self->i_0 = i_0;
  _self->n_0 = n_0;
  return kk_datatype_from_base(&_self->_base, kk_context());
...
static kk_box_t kk_std_core_vector__lift_for_whilez_869_fun119(kk_function_t _fself, kk_box_t _b_x33, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_for_whilez_869_fun119__t* _self = kk_function_as(struct kk_std_core_vector__lift_for_whilez_869_fun119__t*, _fself, _ctx);
  kk_function_t action_0 = _self->action_0; /* (ssize_t) -> 665 maybe<664> */
  kk_ssize_t i_0 = _self->i_0; /* ssize_t */
  kk_ssize_t n_0 = _self->n_0; /* ssize_t */
  kk_drop_match(_self, {kk_function_dup(action_0, _ctx);kk_skip_dup(i_0, _ctx);kk_skip_dup(n_0, _ctx);}, {}, _ctx)
  kk_std_core_types__maybe _y_x10237_0_35 = kk_std_core_types__maybe_unbox(_b_x33, KK_OWNED, _ctx); /*maybe<664>*/;
  kk_std_core_types__maybe _x_x120 = kk_std_core_vector__mlift_lift_for_whilez_869_10258(action_0, i_0, n_0, _y_x10237_0_35, _ctx); /*maybe<664>*/
...
kk_std_core_types__maybe kk_std_core_vector__lift_for_whilez_869(kk_function_t action_0, kk_ssize_t n_0, kk_ssize_t i_0, kk_context_t* _ctx) { /* forall<a,e> (action : (ssize_t) -> e maybe<a>, n : ssize_t, i : ssize_t) -> e maybe<a> */ 
  ...
  if (_match_x54) {
    ...
    kk_function_t _x_x117 = kk_function_dup(action_0, _ctx); /*(ssize_t) -> 665 maybe<664>*/
    x_0_10285 = kk_function_call(kk_std_core_types__maybe, (kk_function_t, kk_ssize_t, kk_context_t*), _x_x117, (_x_x117, i_0, _ctx), _ctx); /*maybe<664>*/
    if (kk_yielding(kk_context())) {
      kk_std_core_types__maybe_drop(x_0_10285, _ctx);
      kk_box_t _x_x118 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_for_whilez_869_fun119(action_0, i_0, n_0, _ctx), _ctx); /*2978*/
...
// specialized: std/core/vector/@lift-for-whilez@869, on parameters @uniq-action@10164, using:
...
// lift anonymous function
struct kk_std_core_vector__lift_foreach_while_10188_fun124__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  kk_vector_t v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_while_10188_fun124(kk_function_t _fself, kk_box_t _b_x37, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_foreach_while_10188_fun124(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_i_10166_0, kk_ssize_t _uniq_n_10165_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_while_10188_fun124__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_foreach_while_10188_fun124__t, 3, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_foreach_while_10188_fun124, kk_context());
  _self->f_0 = f_0;
  _self->v_0 = v_0;
...
static kk_box_t kk_std_core_vector__lift_foreach_while_10188_fun124(kk_function_t _fself, kk_box_t _b_x37, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_foreach_while_10188_fun124__t* _self = kk_function_as(struct kk_std_core_vector__lift_foreach_while_10188_fun124__t*, _fself, _ctx);
  ...
  kk_std_core_types__maybe _y_x10242_0_39 = kk_std_core_types__maybe_unbox(_b_x37, KK_OWNED, _ctx); /*maybe<707>*/;
  kk_std_core_types__maybe _x_x125 = kk_std_core_vector__mlift_lift_foreach_while_10188_10259(_uniq_i_10166_0, _uniq_n_10165_0, f_0, v_0, _y_x10242_0_39, _ctx); /*maybe<707>*/
  return kk_std_core_types__maybe_box(_x_x125, _ctx);
}
...
kk_std_core_types__maybe kk_std_core_vector__lift_foreach_while_10188(kk_function_t f_0, kk_vector_t v_0, kk_ssize_t _uniq_n_10165_0, kk_ssize_t _uniq_i_10166_0, kk_context_t* _ctx) { /* forall<a,b,e> (f : (a) -> e maybe<b>, v : vector<a>, ssize_t, ssize_t) -> e maybe<b> */ 
  ...
  if (_match_x52) {
    ...
    kk_function_t _x_x122 = kk_function_dup(f_0, _ctx); /*(706) -> 708 maybe<707>*/
    kk_box_t _x_x121 = kk_vector_at_borrow(v_0,_uniq_i_10166_0,kk_context()); /*3*/
    x_10288 = kk_function_call(kk_std_core_types__maybe, (kk_function_t, kk_box_t, kk_context_t*), _x_x122, (_x_x122, _x_x121, _ctx), _ctx); /*maybe<707>*/
    if (kk_yielding(kk_context())) {
      kk_std_core_types__maybe_drop(x_10288, _ctx);
      kk_box_t _x_x123 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_foreach_while_10188_fun124(f_0, v_0, _uniq_i_10166_0, _uniq_n_10165_0, _ctx), _ctx); /*2978*/
      return kk_std_core_types__maybe_unbox(_x_x123, KK_OWNED, _ctx);
    }
...
kk_unit_t kk_std_core_vector__mlift_lift_map_10189_10260(kk_ssize_t _uniq_i_10177, kk_ssize_t _uniq_n_10176, kk_function_t f, kk_vector_t v, kk_vector_t w, kk_box_t _y_x10247, kk_context_t* _ctx) { /* forall<a,b,e> (ssize_t, ssize_t, f : (a) -> e b, v : vector<a>, w : vector<b>, b) -> e () */ 
  ...
  kk_vector_t _x_x126 = kk_vector_dup(w, _ctx); /*vector<765>*/
  kk_vector_unsafe_assign(_x_x126,_uniq_i_10177,_y_x10247,kk_context());
...
// specialized: std/core/vector/@lift-forz@868, on parameters @uniq-action@10175, using:
...
// lift anonymous function
struct kk_std_core_vector__lift_map_10189_fun129__t {
  struct kk_function_s _base;
  kk_function_t f_0;
  kk_vector_t v_0;
  kk_vector_t w_0;
...
static kk_box_t kk_std_core_vector__lift_map_10189_fun129(kk_function_t _fself, kk_box_t _b_x41, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector__new_lift_map_10189_fun129(kk_function_t f_0, kk_vector_t v_0, kk_vector_t w_0, kk_ssize_t _uniq_i_10177_0, kk_ssize_t _uniq_n_10176_0, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_map_10189_fun129__t* _self = kk_function_alloc_as(struct kk_std_core_vector__lift_map_10189_fun129__t, 4, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector__lift_map_10189_fun129, kk_context());
  _self->f_0 = f_0;
  _self->v_0 = v_0;
  _self->w_0 = w_0;
...
static kk_box_t kk_std_core_vector__lift_map_10189_fun129(kk_function_t _fself, kk_box_t _b_x41, kk_context_t* _ctx) {
  struct kk_std_core_vector__lift_map_10189_fun129__t* _self = kk_function_as(struct kk_std_core_vector__lift_map_10189_fun129__t*, _fself, _ctx);
  ...
  kk_box_t _y_x10247_0_43 = _b_x41; /*765*/;
...
kk_unit_t kk_std_core_vector__lift_map_10189(kk_function_t f_0, kk_vector_t v_0, kk_vector_t w_0, kk_ssize_t _uniq_n_10176_0, kk_ssize_t _uniq_i_10177_0, kk_context_t* _ctx) { /* forall<a,b,e> (f : (a) -> e b, v : vector<a>, w : vector<b>, ssize_t, ssize_t) -> e () */ 
  ...
  if (_match_x50) {
    kk_box_t x_10027 = kk_vector_at_borrow(v_0,_uniq_i_10177_0,kk_context()); /*764*/;
    kk_box_t x_10291;
    kk_function_t _x_x127 = kk_function_dup(f_0, _ctx); /*(764) -> 766 765*/
    x_10291 = kk_function_call(kk_box_t, (kk_function_t, kk_box_t, kk_context_t*), _x_x127, (_x_x127, x_10027, _ctx), _ctx); /*765*/
    if (kk_yielding(kk_context())) {
      kk_box_drop(x_10291, _ctx);
      kk_box_t _x_x128 = kk_std_core_hnd_yield_extend(kk_std_core_vector__new_lift_map_10189_fun129(f_0, v_0, w_0, _uniq_i_10177_0, _uniq_n_10176_0, _ctx), _ctx); /*2978*/
      kk_unit_unbox(_x_x128); return kk_Unit;
    }
    {
      kk_unit_t _uniq_x___10179_0 = kk_Unit;
      kk_vector_t _x_x131 = kk_vector_dup(w_0, _ctx); /*vector<765>*/
      kk_vector_unsafe_assign(_x_x131,_uniq_i_10177_0,x_10291,kk_context());
...
// lift anonymous function
struct kk_std_core_vector_map_fun137__t {
  struct kk_function_s _base;
  kk_vector_t w;
};
static kk_box_t kk_std_core_vector_map_fun137(kk_function_t _fself, kk_box_t _b_x45, kk_context_t* _ctx);
static kk_function_t kk_std_core_vector_new_map_fun137(kk_vector_t w, kk_context_t* _ctx) {
  struct kk_std_core_vector_map_fun137__t* _self = kk_function_alloc_as(struct kk_std_core_vector_map_fun137__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_vector_map_fun137, kk_context());
  _self->w = w;
  return kk_datatype_from_base(&_self->_base, kk_context());
}

static kk_box_t kk_std_core_vector_map_fun137(kk_function_t _fself, kk_box_t _b_x45, kk_context_t* _ctx) {
  struct kk_std_core_vector_map_fun137__t* _self = kk_function_as(struct kk_std_core_vector_map_fun137__t*, _fself, _ctx);
...
kk_vector_t kk_std_core_vector_map(kk_vector_t v, kk_function_t f, kk_context_t* _ctx) { /* forall<a,b,e> (v : vector<a>, f : (a) -> e b) -> e vector<b> */ 
  kk_vector_t w;
  kk_ssize_t _x_x132;
  kk_integer_t _x_x133;
  kk_ssize_t _x_x134 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/
  _x_x133 = kk_integer_from_ssize_t(_x_x134,kk_context()); /*int*/
  _x_x132 = kk_std_core_int_ssize__t(_x_x133, _ctx); /*ssize_t*/
  w = kk_vector_alloc(_x_x132,kk_box_null(),kk_context()); /*vector<765>*/
  kk_ssize_t n_10020 = kk_vector_len_borrow(v,kk_context()); /*ssize_t*/;
  kk_ssize_t i = (KK_IZ(0)); /*ssize_t*/;
  kk_unit_t x_10294 = kk_Unit;
  kk_vector_t _x_x135 = kk_vector_dup(w, _ctx); /*vector<765>*/
  kk_std_core_vector__lift_map_10189(f, v, _x_x135, n_10020, i, _ctx);
  if (kk_yielding(kk_context())) {
    kk_box_t _x_x136 = kk_std_core_hnd_yield_extend(kk_std_core_vector_new_map_fun137(w, _ctx), _ctx); /*2978*/
    return kk_vector_unbox(_x_x136, _ctx);
  }
  {
    return w;
  }
...
kk_std_core_types__list kk_std_core_vector_vlist(kk_vector_t v, kk_std_core_types__optional tail, kk_context_t* _ctx) { /* forall<a> (v : vector<a>, tail : ? (list<a>)) -> list<a> */ 
  kk_std_core_types__list _x_x138;
  if (kk_std_core_types__is_Optional(tail, _ctx)) {
    kk_box_t _box_x48 = tail._cons._Optional.value;
    kk_std_core_types__list _uniq_tail_782 = kk_std_core_types__list_unbox(_box_x48, KK_BORROWED, _ctx);
    kk_std_core_types__list_dup(_uniq_tail_782, _ctx);
    kk_std_core_types__optional_drop(tail, _ctx);
    _x_x138 = _uniq_tail_782; /*list<795>*/
  }
  else {
    kk_std_core_types__optional_drop(tail, _ctx);
    _x_x138 = kk_std_core_types__new_Nil(_ctx); /*list<795>*/
  }
  return kk_vector_to_list(v,_x_x138,kk_context());
}
