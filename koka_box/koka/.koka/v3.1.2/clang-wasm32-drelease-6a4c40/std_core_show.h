...
static inline kk_string_t kk_std_core_show_char_fs_show(kk_char_t c, kk_context_t* _ctx) { /* (c : char) -> string */ 
  ...
  kk_string_t _x_x206;
  kk_string_t _x_x207 = kk_std_core_show_show_char(c, _ctx); /*string*/
  kk_string_t _x_x208;
  kk_define_string_literal(, _s_x209, 1, "\'", _ctx)
  _x_x208 = kk_string_dup(_s_x209, _ctx); /*string*/
  _x_x206 = kk_std_core_types__lp__plus__plus__rp_(_x_x207, _x_x208, _ctx); /*string*/
  return kk_std_core_types__lp__plus__plus__rp_(_x_x204, _x_x206, _ctx);
}
...
static inline kk_string_t kk_std_core_show_sslice_fs_show(kk_std_core_sslice__sslice s, kk_context_t* _ctx) { /* (s : sslice/sslice) -> string */ 
  kk_string_t _x_x227 = kk_std_core_sslice_string(s, _ctx); /*string*/
  return kk_std_core_show_string_fs_show(_x_x227, _ctx);
}
