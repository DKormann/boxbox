...
static inline kk_box_t kk_std_core_stream_fs_head(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> a */ 
  {
    struct kk_std_core_Next* _con_x81 = kk_std_core__as_Next(stream, _ctx);
    kk_box_t _x = _con_x81->head;
...
static inline kk_std_core__stream kk_std_core_stream_fs_tail(kk_std_core__stream stream, kk_context_t* _ctx) { /* forall<a> (stream : stream<a>) -> stream<a> */ 
  {
    struct kk_std_core_Next* _con_x82 = kk_std_core__as_Next(stream, _ctx);
    kk_std_core__stream _x = _con_x82->tail;
...
struct kk_std_core_const_fun88__t {
...
static inline kk_function_t kk_std_core_new_const_fun88(kk_box_t kkloc_default, kk_context_t* _ctx) {
  struct kk_std_core_const_fun88__t* _self = kk_function_alloc_as(struct kk_std_core_const_fun88__t, 2, _ctx);
  _self->_base.fun = kk_kkfun_ptr_box(&kk_std_core_const_fun88, kk_context());
...
static inline kk_function_t kk_std_core_const(kk_box_t kkloc_default, kk_context_t* _ctx) { /* forall<a,b> (default : a) -> ((x : b) -> a) */ 
  return kk_std_core_new_const_fun88(kkloc_default, _ctx);
}
...
static inline bool kk_std_core_cmp_fs__lp__eq__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order _match_x75 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/;
  if (kk_std_core_types__is_Eq(_match_x75, _ctx)) {
    return true;
  }
  {
    return false;
...
static inline bool kk_std_core__lp__excl__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs__lp__eq__eq__rp_, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?(==) : (a, a) -> bool) -> bool */ 
  bool b_10002 = kk_function_call(bool, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs__lp__eq__eq__rp_, (_implicit_fs__lp__eq__eq__rp_, x, y, _ctx), _ctx); /*bool*/;
  if (b_10002) {
    return false;
  }
  {
...
static inline bool kk_std_core__lp__gt__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order x_0_10003 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/;
  kk_integer_t _brw_x73;
  if (kk_std_core_types__is_Lt(x_0_10003, _ctx)) {
    _brw_x73 = kk_integer_from_small(-1); /*int*/
    goto _match_x101;
  }
  if (kk_std_core_types__is_Eq(x_0_10003, _ctx)) {
    _brw_x73 = kk_integer_from_small(0); /*int*/
    goto _match_x101;
  }
  {
    _brw_x73 = kk_integer_from_small(1); /*int*/
  ...
  _match_x101: ;
  bool _brw_x74 = kk_integer_eq_borrow(_brw_x73,(kk_integer_from_small(1)),kk_context()); /*bool*/;
...
static inline kk_box_t kk_std_core_fold(kk_integer_t upto, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (upto : int, init : a, f : (int, a) -> e a) -> e a */ 
  kk_integer_t _x_x107 = kk_integer_add_small_const(upto, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold(kk_integer_from_small(0), _x_x107, init, f, _ctx);
}
...
static inline kk_box_t kk_std_core_fold_while(kk_integer_t n, kk_box_t init, kk_function_t f, kk_context_t* _ctx) { /* forall<a,e> (n : int, init : a, f : (int, a) -> e maybe<a>) -> e a */ 
  kk_integer_t _x_x115 = kk_integer_add_small_const(n, -1, _ctx); /*int*/
  return kk_std_core_range_fs_fold_while(kk_integer_from_small(0), _x_x115, init, f, _ctx);
}
...
static inline bool kk_std_core__lp__lt__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order x_0_10005 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, x, y, _ctx), _ctx); /*order*/;
  kk_integer_t _brw_x67;
  if (kk_std_core_types__is_Lt(x_0_10005, _ctx)) {
    _brw_x67 = kk_integer_from_small(-1); /*int*/
    goto _match_x116;
  }
  if (kk_std_core_types__is_Eq(x_0_10005, _ctx)) {
    _brw_x67 = kk_integer_from_small(0); /*int*/
    goto _match_x116;
  }
  {
    _brw_x67 = kk_integer_from_small(1); /*int*/
  ...
  _match_x116: ;
  bool _brw_x68 = kk_integer_eq_borrow(_brw_x67,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x67, _ctx);
  return _brw_x68;
}
...
static inline bool kk_std_core__lp__gt__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order x_0_10005 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, y, x, _ctx), _ctx); /*order*/;
  kk_integer_t _brw_x65;
  if (kk_std_core_types__is_Lt(x_0_10005, _ctx)) {
    _brw_x65 = kk_integer_from_small(-1); /*int*/
    goto _match_x117;
  }
  if (kk_std_core_types__is_Eq(x_0_10005, _ctx)) {
    _brw_x65 = kk_integer_from_small(0); /*int*/
    goto _match_x117;
  }
  {
    _brw_x65 = kk_integer_from_small(1); /*int*/
  ...
  _match_x117: ;
  bool _brw_x66 = kk_integer_eq_borrow(_brw_x65,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x65, _ctx);
  return _brw_x66;
}
...
static inline bool kk_std_core__lp__lt__eq__rp_(kk_box_t x, kk_box_t y, kk_function_t _implicit_fs_cmp, kk_context_t* _ctx) { /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */ 
  kk_std_core_types__order x_0_10003 = kk_function_call(kk_std_core_types__order, (kk_function_t, kk_box_t, kk_box_t, kk_context_t*), _implicit_fs_cmp, (_implicit_fs_cmp, y, x, _ctx), _ctx); /*order*/;
  ...
  _match_x118: ;
  bool _brw_x64 = kk_integer_eq_borrow(_brw_x63,(kk_integer_from_small(1)),kk_context()); /*bool*/;
...
static inline kk_unit_t kk_std_core_range_fs_for(kk_integer_t start, kk_integer_t end, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (start : int, end : int, action : (int) -> e ()) -> e () */ 
  kk_integer_t _x_x124 = kk_integer_dup(start, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1256(action, end, _x_x124, _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_for(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : (int) -> e ()) -> e () */ 
  ...
  kk_integer_t _x_x125 = kk_integer_dup(n, _ctx); /*int*/
  end_10009 = kk_integer_add_small_const(_x_x125, -1, _ctx); /*int*/
  kk_std_core_range_fs__lift_for_1256(action, end_10009, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
static inline kk_unit_t kk_std_core_repeat(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<e> (n : int, action : () -> e ()) -> e () */ 
  ...
  kk_integer_t _x_x130 = kk_integer_dup(n, _ctx); /*int*/
  end_10014 = kk_integer_add_small_const(_x_x130, -1, _ctx); /*int*/
  kk_std_core__lift_repeat_10138(action, end_10014, kk_integer_from_small(0), _ctx); return kk_Unit;
}
...
static inline kk_std_core_types__maybe kk_std_core_for_while(kk_integer_t n, kk_function_t action, kk_context_t* _ctx) { /* forall<a,e> (n : int, action : (int) -> e maybe<a>) -> e maybe<a> */ 
  ...
  return kk_std_core_range_fs__lift_for_while_1257(action, end_10018, kk_integer_from_small(0), _ctx);
}
