...
static inline bool kk_std_core_string__lp__lt__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  _match_x31: ;
  bool _brw_x27 = kk_integer_eq_borrow(_brw_x26,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
...
static inline bool kk_std_core_string__lp__lt__eq__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  kk_integer_t _brw_x24;
  if (kk_std_core_types__is_Lt(x_0_10003, _ctx)) {
    _brw_x24 = kk_integer_from_small(-1); /*int*/
    goto _match_x32;
  }
  if (kk_std_core_types__is_Eq(x_0_10003, _ctx)) {
    _brw_x24 = kk_integer_from_small(0); /*int*/
    goto _match_x32;
  }
  {
    _brw_x24 = kk_integer_from_small(1); /*int*/
  ...
  _match_x32: ;
  bool _brw_x25 = kk_integer_lt_borrow(_brw_x24,(kk_integer_from_small(1)),kk_context()); /*bool*/;
  kk_integer_drop(_brw_x24, _ctx);
  return _brw_x25;
}
...
static inline bool kk_std_core_string__lp__gt__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  _match_x34: ;
  bool _brw_x20 = kk_integer_eq_borrow(_brw_x19,(kk_integer_from_small(1)),kk_context()); /*bool*/;
...
static inline bool kk_std_core_string__lp__gt__eq__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> bool */ 
  ...
  _match_x35: ;
  bool _brw_x18 = kk_integer_gt_borrow(_brw_x17,(kk_integer_from_small(-1)),kk_context()); /*bool*/;
...
static inline kk_string_t kk_std_core_string_repeat(kk_string_t s, kk_integer_t n, kk_context_t* _ctx) { /* (s : string, n : int) -> string */ 
  kk_ssize_t _x_x36;
  kk_integer_t _x_x37 = kk_integer_dup(n, _ctx); /*int*/
  _x_x36 = kk_std_core_int_ssize__t(_x_x37, _ctx); /*ssize_t*/
  return kk_std_core_string_repeatz(s, _x_x36, _ctx);
}
...
static inline kk_string_t kk_std_core_string_maybe_fs_string(kk_std_core_types__maybe ms, kk_context_t* _ctx) { /* (ms : maybe<string>) -> string */ 
  ...
  {
    kk_box_t _box_x8 = ms._cons.Just.value;
    kk_string_t s = kk_string_unbox(_box_x8);
...
static inline bool kk_std_core_string_is_empty(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x_x39 = kk_string_empty(); /*string*/
  return kk_string_is_eq(s,_x_x39,kk_context());
}
...
static inline kk_string_t kk_std_core_string__lp__bar__bar__rp_(kk_string_t x, kk_string_t y, kk_context_t* _ctx) { /* (x : string, y : string) -> string */ 
  bool _match_x16;
  kk_string_t _x_x41 = kk_string_dup(x, _ctx); /*string*/
  kk_string_t _x_x42 = kk_string_empty(); /*string*/
  _match_x16 = kk_string_is_eq(_x_x41,_x_x42,kk_context()); /*bool*/
  if (_match_x16) {
...
static inline bool kk_std_core_string_is_notempty(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> bool */ 
  kk_string_t _x_x44 = kk_string_empty(); /*string*/
  return kk_string_is_neq(s,_x_x44,kk_context());
}
...
static inline kk_string_t kk_std_core_string_trim(kk_string_t s, kk_context_t* _ctx) { /* (s : string) -> string */ 
  kk_string_t _x_x57 = kk_string_trim_left(s,kk_context()); /*string*/
  return kk_string_trim_right(_x_x57,kk_context());
}
...
static inline kk_std_core_types__list kk_std_core_string_splitn_fs_split(kk_string_t s, kk_string_t sep, kk_integer_t n, kk_context_t* _ctx) { /* (s : string, sep : string, n : int) -> list<string> */ 
  kk_vector_t v_10020;
  kk_ssize_t _x_x58;
  kk_integer_t _x_x59 = kk_integer_dup(n, _ctx); /*int*/
  _x_x58 = kk_std_core_int_ssize__t(_x_x59, _ctx); /*ssize_t*/
  v_10020 = kk_string_splitv_atmost(s,sep,_x_x58,kk_context()); /*vector<string>*/
