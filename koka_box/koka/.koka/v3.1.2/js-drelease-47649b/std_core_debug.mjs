...
export function trace_show(x, _implicit_fs_show, _implicit_fs_kk_file_line) /* forall<a> (x : a, ?show : (a) -> string, ?kk-file-line : string) -> () */  {
  ...
  var message_10004 = _implicit_fs_show(x);
   
  var message_0_10006 = $std_core_types._lp__plus__plus__rp_(_implicit_fs_kk_file_line, $std_core_types._lp__plus__plus__rp_(": ", message_10004));
  var _x2 = trace_enabled.value;
  if (_x2) {
    return xtrace(message_0_10006);
  }
  else {
    return $std_core_types.Unit;
  }
