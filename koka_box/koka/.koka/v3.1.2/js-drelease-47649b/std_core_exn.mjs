...
export function throw_exn(exn_0) /* forall<a> (exn : exception) -> exn a */  {
  ...
  var ev_10130 = $std_core_hnd._evv_at(0);
  var _x2 = ev_10130.hnd._brk_throw_exn;
  return _x2(ev_10130.marker, ev_10130, exn_0);
}
...
export function $throw(message, info) /* forall<a> (message : string, info : ? exception-info) -> exn a */  {
  ...
  var ev_10133 = $std_core_hnd._evv_at(0);
  var _x3 = ev_10133.hnd._brk_throw_exn;
  var _x4 = (info !== undefined) ? info : ExnError;
  return _x3(ev_10133.marker, ev_10133, Exception(message, _x4));
}
...
export function error_pattern(location, definition) /* forall<a> (location : string, definition : string) -> exn a */  {
  ...
  var _x5 = ev_10136.hnd._brk_throw_exn;
  return _x5(ev_10136.marker, ev_10136, Exception(message_10003, ExnPattern(location, definition)));
}
...
export function exn_fs_try(action, hndl) /* forall<a,e> (action : () -> <exn|e> a, hndl : (exception) -> e a) -> e a */  {
  return _handle_exn(_Hnd_exn(0, function(m /* hnd/marker<638,637> */ , ___wildcard_x638__16 /* hnd/ev<exn> */ , x /* exception */ ) {
        return $std_core_hnd.yield_to_final(m, function(___wildcard_x638__45 /* (hnd/resume-result<625,637>) -> 638 637 */ ) {
            return hndl(x);
          });
      }), function(_x /* 637 */ ) {
      return _x;
...
// monadic lift
export function _mlift_try_10128(_y_x10120) /* forall<a,e> (a) -> <exn|e> error<a> */  {
  return Ok(_y_x10120);
}
...
export function $try(action) /* forall<a,e> (action : () -> <exn|e> a) -> e error<a> */  {
  return _handle_exn(_Hnd_exn(0, function(m /* hnd/marker<678,error<677>> */ , ___wildcard_x638__16 /* hnd/ev<exn> */ , x /* exception */ ) {
        return $std_core_hnd.yield_to_final(m, function(___wildcard_x638__45 /* (hnd/resume-result<625,error<677>>) -> 678 error<677> */ ) {
            return $Error(x);
          });
      }), function(_x /* error<677> */ ) {
      return _x;
    }, function() {
       
      var x_0_10141 = action();
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(_y_x10120 /* 677 */ ) {
          return Ok(_y_x10120);
        });
      }
      else {
...
export function $catch(action, hndl) /* forall<a,e> (action : () -> <exn|e> a, hndl : (exception) -> e a) -> e a */  {
  return _handle_exn(_Hnd_exn(0, function(m /* hnd/marker<708,707> */ , ___wildcard_x638__16 /* hnd/ev<exn> */ , x /* exception */ ) {
        return $std_core_hnd.yield_to_final(m, function(___wildcard_x638__45 /* (hnd/resume-result<625,707>) -> 708 707 */ ) {
            return hndl(x);
          });
      }), function(_x /* 707 */ ) {
      return _x;
...
export function untry(err) /* forall<a> (err : error<a>) -> exn a */  {
  if (err._tag === 1) {
    ...
    var ev_10145 = $std_core_hnd._evv_at(0);
    var _x6 = ev_10145.hnd._brk_throw_exn;
    return _x6(ev_10145.marker, ev_10145, err.exception);
  }
  else {
    return err.result;
  }
...
export function exn_error_range() /* forall<a> () -> exn a */  {
  ...
  var ev_10150 = $std_core_hnd._evv_at(0);
  var _x7 = ev_10150.hnd._brk_throw_exn;
  return _x7(ev_10150.marker, ev_10150, Exception("index out-of-range", ExnRange));
}