...
// monadic lift
export function _mlift_while_10193(action, predicate, wild__) /* forall<e> (action : () -> <div|e> (), predicate : () -> <div|e> bool, wild_ : ()) -> <div|e> () */  {
  return $while(predicate, action);
}
 
 
// monadic lift
export function _mlift_while_10194(action_0, predicate_0, _y_x10146) /* forall<e> (action : () -> <div|e> (), predicate : () -> <div|e> bool, bool) -> <div|e> () */  {
  if (_y_x10146) {
     
    var x_10202 = action_0();
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return _mlift_while_10193(action_0, predicate_0, wild___0);
      });
    }
    else {
      return _mlift_while_10193(action_0, predicate_0, x_10202);
    }
  }
  else {
    return $std_core_types.Unit;
...
export function $while(predicate_1, action_1) /* forall<e> (predicate : () -> <div|e> bool, action : () -> <div|e> ()) -> <div|e> () */  { tailcall: while(1)
{
  ...
  var x_0_10204 = predicate_1();
  if ($std_core_hnd._yielding()) {
    return $std_core_hnd.yield_extend(function(_y_x10146_0 /* bool */ ) {
      return _mlift_while_10194(action_1, predicate_1, _y_x10146_0);
    });
  }
  else {
    if (x_0_10204) {
       
      var x_1_10207 = action_1();
      if ($std_core_hnd._yielding()) {
        return $std_core_hnd.yield_extend(function(wild___1 /* () */ ) {
          return _mlift_while_10193(action_1, predicate_1, wild___1);
        });
      }
      else {
        {
...
export function _lp__gt__rp_(x, y, _implicit_fs_cmp) /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */  {
  ...
  var x_0_10003 = _implicit_fs_cmp(x, y);
  if (x_0_10003 === 1) {
    var _x3 = -1;
  }
  else if (x_0_10003 === 2) {
  ...
  return $std_core_types._int_eq(_x3,1);
}
 
 
// monadic lift
export function range_fs__mlift_fold_10195(end, f, start, x) /* forall<a,e> (end : int, f : (int, a) -> e a, start : int, x : a) -> e a */  {
...
export function range_fs_fold(start_0, end_0, init, f_0) /* forall<a,e> (start : int, end : int, init : a, f : (int, a) -> e a) -> e a */  { tailcall: while(1)
{
  if ($std_core_types._int_gt(start_0,end_0)) {
    ...
    var x_0_10210 = f_0(start_0, init);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(x_1 /* 588 */ ) {
        return range_fs__mlift_fold_10195(end_0, f_0, start_0, x_1);
      });
    }
    else {
      {
...
// monadic lift
export function range_fs__mlift_fold_while_10196(end, f, init, start, _y_x10154) /* forall<a,e> (end : int, f : (int, a) -> e maybe<a>, init : a, start : int, maybe<a>) -> e a */  {
  if (_y_x10154 !== null) {
    return range_fs_fold_while($std_core_types._int_add(start,1), end, _y_x10154.value, f);
  }
  else {
    return init;
  }
...
export function range_fs_fold_while(start_0, end_0, init_0, f_0) /* forall<a,e> (start : int, end : int, init : a, f : (int, a) -> e maybe<a>) -> e a */  { tailcall: while(1)
{
  if ($std_core_types._int_gt(start_0,end_0)) {
    ...
    var x_0_10213 = f_0(start_0, init_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10154_0 /* maybe<685> */ ) {
        return range_fs__mlift_fold_while_10196(end_0, f_0, init_0, start_0, _y_x10154_0);
      });
    }
    else {
      if (x_0_10213 !== null) {
        {
          // tail call
          var _x5 = $std_core_types._int_add(start_0,1);
          start_0 = _x5;
          init_0 = x_0_10213.value;
          continue tailcall;
        }
      }
      else {
...
export function _lp__lt__rp_(x, y, _implicit_fs_cmp) /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */  {
  ...
  var x_0_10005 = _implicit_fs_cmp(x, y);
  if (x_0_10005 === 1) {
    var _x6 = -1;
  }
  else if (x_0_10005 === 2) {
  ...
  return $std_core_types._int_eq(_x6,(-1));
}
...
export function _lp__gt__eq__rp_(x, y, _implicit_fs_cmp) /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */  {
  ...
  var x_0_10005 = _implicit_fs_cmp(y, x);
  if (x_0_10005 === 1) {
    var _x7 = -1;
  }
  else if (x_0_10005 === 2) {
  ...
  return $std_core_types._int_eq(_x7,(-1));
}
...
export function _lp__lt__eq__rp_(x, y, _implicit_fs_cmp) /* forall<a> (x : a, y : a, ?cmp : (a, a) -> order) -> bool */  {
  ...
  var x_0_10003 = _implicit_fs_cmp(y, x);
  if (x_0_10003 === 1) {
    var _x8 = -1;
  }
  else if (x_0_10003 === 2) {
  ...
  return $std_core_types._int_eq(_x8,1);
}
 
 
// monadic lift
export function range_fs__mlift_lift_for_1256_10197(action, end, i, wild__) /* forall<e> (action : (int) -> e (), end : int, i : int, wild_ : ()) -> e () */  {
   
  var i_0_10007 = $std_core_types._int_add(i,1);
  return range_fs__lift_for_1256(action, end, i_0_10007);
}
...
export function range_fs__lift_for_1256(action_0, end_0, i_0) /* forall<e> (action : (int) -> e (), end : int, i : int) -> e () */  { tailcall: while(1)
{
  if ($std_core_types._int_le(i_0,end_0)) {
    ...
    var x_10216 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(wild___0 /* () */ ) {
        return range_fs__mlift_lift_for_1256_10197(action_0, end_0, i_0, wild___0);
      });
    }
    else {
       
      var i_0_10007_0 = $std_core_types._int_add(i_0,1);
      {
        // tail call
        i_0 = i_0_10007_0;
        continue tailcall;
...
export function $for(n, action) /* forall<e> (n : int, action : (int) -> e ()) -> e () */  {
  ...
  var end_10009 = $std_core_types._int_sub(n,1);
  return range_fs__lift_for_1256(action, end_10009, 0);
}
 
 
// monadic lift
export function _mlift_lift_repeat_10138_10198(_uniq_end_10129, _uniq_i_10130, action, _uniq_x___10132) /* forall<e> (int, int, action : () -> e (), ()) -> e () */  {
   
  var _uniq_i_0_10007_10134 = $std_core_types._int_add(_uniq_i_10130,1);
  return _lift_repeat_10138(action, _uniq_end_10129, _uniq_i_0_10007_10134);
}
...
//   action();
// }
export function _lift_repeat_10138(action_0, _uniq_end_10129_0, _uniq_i_10130_0) /* forall<e> (action : () -> e (), int, int) -> e () */  { tailcall: while(1)
{
  if ($std_core_types._int_le(_uniq_i_10130_0,_uniq_end_10129_0)) {
     
    var x_10219 = action_0();
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_uniq_x___10132_0 /* () */ ) {
        return _mlift_lift_repeat_10138_10198(_uniq_end_10129_0, _uniq_i_10130_0, action_0, _uniq_x___10132_0);
      });
    }
    else {
       
      var _uniq_i_0_10007_10134_0 = $std_core_types._int_add(_uniq_i_10130_0,1);
      {
        // tail call
...
export function repeat(n, action) /* forall<e> (n : int, action : () -> e ()) -> e () */  {
  ...
  var end_10014 = $std_core_types._int_sub(n,1);
  return _lift_repeat_10138(action, end_10014, 0);
}
 
 
// monadic lift
export function range_fs__mlift_lift_for_while_1257_10199(action, end, i, _y_x10168) /* forall<a,e> (action : (int) -> e maybe<a>, end : int, i : int, maybe<a>) -> e maybe<a> */  {
  if (_y_x10168 === null) {
     
    var i_0_10016 = $std_core_types._int_add(i,1);
    return range_fs__lift_for_while_1257(action, end, i_0_10016);
  }
  else {
    return $std_core_types.Just(_y_x10168.value);
  }
}
...
export function range_fs__lift_for_while_1257(action_0, end_0, i_0) /* forall<a,e> (action : (int) -> e maybe<a>, end : int, i : int) -> e maybe<a> */  { tailcall: while(1)
{
  if ($std_core_types._int_le(i_0,end_0)) {
    ...
    var x_0_10222 = action_0(i_0);
    if ($std_core_hnd._yielding()) {
      return $std_core_hnd.yield_extend(function(_y_x10168_0 /* maybe<961> */ ) {
        return range_fs__mlift_lift_for_while_1257_10199(action_0, end_0, i_0, _y_x10168_0);
      });
    }
    else {
      if (x_0_10222 === null) {
         
        var i_0_10016_0 = $std_core_types._int_add(i_0,1);
        {
          // tail call
          i_0 = i_0_10016_0;
          continue tailcall;
        ...
        return $std_core_types.Just(x_0_10222.value);
      }
    }
  }
  else {
...
export function for_while(n, action) /* forall<a,e> (n : int, action : (int) -> e maybe<a>) -> e maybe<a> */  {
  ...
  var end_10018 = $std_core_types._int_sub(n,1);
  return range_fs__lift_for_while_1257(action, end_10018, 0);
}
